...
func supervisedCatalogFactoryConfig() *interfaces.FactoryConfig {
...
func newSupervisedTestHost(t *testing.T, launcher *fakeProcessLauncher) *CatalogHost {
	...
	host := mustNewCatalogHost(t, stubAssetGateway{
		...
		Supervisor: SupervisorConfig{
			...
			HealthChecker:       HTTPHealthChecker{Path: "/health"},
...
func TestLoadedFactoryConfigForSupervisedTests(t *testing.T) {
	loaded, err := factoryconfig.NewLoadedFactoryConfig(t.TempDir(), supervisedCatalogFactoryConfig(), nil)
	if err != nil {
