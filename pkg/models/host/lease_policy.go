...
func normalizeLeasePolicyOptions(opts Options) (idleUnloadAfter time.Duration, maxLoadedRuntimes int) {
	idleUnloadAfter = opts.IdleUnloadAfter
	if idleUnloadAfter < 0 {
		idleUnloadAfter = 0
	}
	maxLoadedRuntimes = opts.MaxLoadedRuntimes
...
func (h *CatalogHost) leaseCapacityForModel(runtimeCfg *factoryconfig.LoadedFactoryConfig, modelName string) int {
