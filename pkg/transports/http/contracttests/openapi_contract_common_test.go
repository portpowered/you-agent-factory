...
var canonicalFactoryEventPayloadSchemaNamesByType = map[string]string{
	...
	"HUMAN_APPROVAL_REQUESTED":            "HumanApprovalRequestedEventPayload",
	"DISPATCH_WORKER_SESSION_ASSOCIATION": "DispatchWorkerSessionAssociationEventPayload",
	...
	"DISPATCH_RESULT_IGNORED":             "DispatchResultIgnoredEventPayload",
