...
func resolvePrimaryResultRegressionFixture(name string) (invocations.PrimaryResultSelection, error) {
	switch name {
	...
	default:
		return invocations.PrimaryResultSelection{}, os.ErrNotExist
	}
}
