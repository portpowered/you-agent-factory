...
func TestWorkerWorkstationCompatibilityHelpers(t *testing.T) {
	...
	t.Run("compatibility exemptions and workstation types", testWorkerCompatibilityExemptionsAndTypes)
	t.Run("worker behavior classes", testWorkerCompatibilityBehaviorClasses)
	t.Run("expected workstation behavior classes", testWorkerCompatibilityExpectedBehaviorClasses)
}

func testWorkerCompatibilityExemptionsAndTypes(t *testing.T) {
	t.Helper()
...
func testWorkerCompatibilityBehaviorClasses(t *testing.T) {
	t.Helper()
...
func testWorkerCompatibilityExpectedBehaviorClasses(t *testing.T) {
	t.Helper()
