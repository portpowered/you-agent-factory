...
func artifactRefFromState(state interfaces.FactorySessionArtifactState) factoryapi.FactoryArtifactRef {
	artifact := projectedArtifact(state)
	...
	if artifact.SizeBytes != nil {
		ref.SizeBytes = artifact.SizeBytes
	}
	return ref
}
