...
func TestNewServiceFromConfigDocumentConstructsFromPorts(t *testing.T) {
	...
	root, err := operatorsettingsservicewire.NewServiceFromConfigDocument(testConfigDocumentService())
	if err != nil {
...
func TestNewServiceFromConfigDocumentUsesInjectedDocumentOwner(t *testing.T) {
	...
	service.DocumentOwner = operatorsettingsservicewire.NewDocumentOwner(
		service.Files,
		service.CreateTemp,
		service.Decoder,
		service.Encoder,
...
func TestNewConfigDocumentServiceConstructsDocumentOwner(t *testing.T) {
	...
	service := operatorsettingsservicewire.NewConfigDocumentService(
...
func TestCompositionRootDelegatesDocumentAndResolutionOperations(t *testing.T) {
	t.Parallel()
