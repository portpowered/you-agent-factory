...
type (
	...
	DispatchResultIgnoredEventPayload                          = recordingcontracts.DispatchResultIgnoredEventPayload
	ObservedWorkState                                          = recordingcontracts.ObservedWorkState
	...
	DispatchResultIgnoredInput                                 = recordingcontracts.DispatchResultIgnoredInput
	DispatchResultIgnoredRecorder                              = recordingcontracts.DispatchResultIgnoredRecorder
...
const (
	...
	FactoryEventTypeDispatchResultIgnored          = recordingcontracts.FactoryEventTypeDispatchResultIgnored
	...
	DispatchResultIgnoredReasonWorkAlreadyTerminal = recordingcontracts.DispatchResultIgnoredReasonWorkAlreadyTerminal
