...
func (h *FactoryEventHistory) dispatchResourcesPtr(tokens []workerexecution.Token) *[]interfaces.DispatchResourceRef {
...
func (h *FactoryEventHistory) dispatchResource(resourceID string) interfaces.DispatchResourceRef {
	...
	for _, definition := range h.initialStructure.Resources {
