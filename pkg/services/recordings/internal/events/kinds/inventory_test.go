...
var knownRuntimeEmissionAnchors = map[recordings.FactoryEventType]string{
	...
	recordings.FactoryEventTypeInferenceRequest:              "pkg/services/workers/internal/providercompat/recording_provider.go",
	recordings.FactoryEventTypeInferenceResponse:             "pkg/services/workers/internal/providercompat/recording_provider.go",
