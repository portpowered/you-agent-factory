...
var knownRuntimeEmissionAnchors = map[recordings.FactoryEventType]string{
	...
	recordings.FactoryEventTypeInferenceRequest:              "pkg/services/workers/internal/services/workstations/execution/recording/provider.go",
	recordings.FactoryEventTypeInferenceResponse:             "pkg/services/workers/internal/services/workstations/execution/recording/provider.go",
