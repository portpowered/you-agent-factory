...
var knownRuntimeEmissionAnchors = map[recordings.FactoryEventType]string{
	...
	recordings.FactoryEventTypeRunResponse:                   "pkg/services/recordings/internal/events/event_history.go RecordRunResponse",
	recordings.FactoryEventTypeWorkStateChange:               "pkg/services/recordings/internal/events/event_history.go RecordWorkStateChange",
	recordings.FactoryEventTypeInferenceRequest:              "pkg/services/workers/internal/execution/recording/provider.go",
	recordings.FactoryEventTypeInferenceResponse:             "pkg/services/workers/internal/execution/recording/provider.go",
	recordings.FactoryEventTypeModelRequest:                  "pkg/services/workers/internal/execution/recording/model.go",
	recordings.FactoryEventTypeModelResponse:                 "pkg/services/workers/internal/execution/recording/model.go",
	...
	recordings.FactoryEventTypeSessionStarted:                "pkg/services/recordings/internal/events/event_history_session_lifecycle.go RecordSessionStarted",
	recordings.FactoryEventTypeSessionPaused:                 "pkg/services/recordings/internal/events/event_history_session_lifecycle.go RecordSessionPaused",
	recordings.FactoryEventTypeSessionResumed:                "pkg/services/recordings/internal/events/event_history_session_lifecycle.go RecordSessionResumed",
	recordings.FactoryEventTypeSessionResultUpdated:          "pkg/services/recordings/internal/events/event_history_session_lifecycle.go RecordSessionResultUpdated",
	recordings.FactoryEventTypeSessionCompleted:              "pkg/services/recordings/internal/events/event_history_session_lifecycle.go RecordSessionCompleted",
	recordings.FactoryEventTypeSessionLifecycleControl:       "pkg/services/recordings/internal/events/event_history_session_lifecycle.go RecordSessionLifecycleControl",
	recordings.FactoryEventTypeOrchestratorPhaseChanged:      "pkg/services/recordings/internal/events/event_history_orchestrator_progress.go RecordOrchestratorPhaseChanged",
	recordings.FactoryEventTypeOrchestratorCheckpointWritten: "pkg/services/recordings/internal/events/event_history_orchestrator_progress.go RecordOrchestratorCheckpointWritten",
