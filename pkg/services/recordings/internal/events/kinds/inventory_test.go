...
var knownRuntimeEmissionAnchors = map[recordings.FactoryEventType]string{
	...
	recordings.FactoryEventTypeInferenceRequest:              "pkg/services/workers/providercompat/recording_provider.go",
	recordings.FactoryEventTypeInferenceResponse:             "pkg/services/workers/providercompat/recording_provider.go",
