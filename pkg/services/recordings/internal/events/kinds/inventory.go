...
func PublicEmittableFactoryEventKinds() []PublicEmittableKind {
	kinds := []PublicEmittableKind{
		...
		{Kind: recordings.FactoryEventTypeInferenceRequest, EmissionEvidence: "pkg/services/providers/internal/services/execution/internal/provider/recording_provider.go and pkg/services/recordings/internal/events/event_history.go RecordInferenceEvent"},
		{Kind: recordings.FactoryEventTypeInferenceResponse, EmissionEvidence: "pkg/services/providers/internal/services/execution/internal/provider/recording_provider.go and pkg/services/recordings/internal/events/event_history.go RecordInferenceEvent"},
		{Kind: recordings.FactoryEventTypeModelRequest, EmissionEvidence: "pkg/services/workers/internal/services/workstations/execution/recording/model.go and pkg/services/recordings/internal/events/event_history.go RecordModelEvent"},
		{Kind: recordings.FactoryEventTypeModelResponse, EmissionEvidence: "pkg/services/workers/internal/services/workstations/execution/recording/model.go and pkg/services/recordings/internal/events/event_history.go RecordModelEvent"},
