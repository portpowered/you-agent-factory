...
func PublicEmittableFactoryEventKinds() []PublicEmittableKind {
	kinds := []PublicEmittableKind{
		...
		{Kind: recordings.FactoryEventTypeInferenceRequest, EmissionEvidence: "pkg/services/workers/internal/providercompat/recording_provider.go and pkg/services/recordings/internal/events/event_history.go RecordInferenceEvent"},
		{Kind: recordings.FactoryEventTypeInferenceResponse, EmissionEvidence: "pkg/services/workers/internal/providercompat/recording_provider.go and pkg/services/recordings/internal/events/event_history.go RecordInferenceEvent"},
