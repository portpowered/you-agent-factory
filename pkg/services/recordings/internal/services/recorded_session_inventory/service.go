// Package recordedsessioninventory implements the Recordings-owned, read-only
// inventory of dated Factory Session recording artifacts.
...
var _ recordings.RecordedSessionInventory = (*service)(nil)
