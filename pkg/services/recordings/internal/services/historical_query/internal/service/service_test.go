...
func TestQueryHistoricalRecordingReadsAndProjectsPortableArtifact(t *testing.T) {
	...
	query := New(func(reference string) ([]byte, error) {
		...
		return payload, nil
	}, recordingsinternal.NewProjectionService(), logging.NoopLogger{}, testHistoricalQueryClock())
...
func TestQueryHistoricalRecordingClassifiesMissingAndCorruptHistory(t *testing.T) {
	...
	t.Run("missing", func(t *testing.T) {
		query := New(func(string) ([]byte, error) { return nil, os.ErrNotExist }, recordingsinternal.NewProjectionService(), logging.NoopLogger{}, testHistoricalQueryClock())
	...
	t.Run("unreadable", func(t *testing.T) {
		query := New(func(string) ([]byte, error) { return nil, os.ErrPermission }, recordingsinternal.NewProjectionService(), logging.NoopLogger{}, testHistoricalQueryClock())
		_, err := query.QueryHistoricalRecording(recordings.HistoricalRecordingQueryRequest{Recording: identity})
