...
func PublicEmittableFactoryEventKinds() []PublicEmittableKind {
	kinds := []PublicEmittableKind{
		...
		{Kind: recordings.FactoryEventTypeScriptResponse, EmissionEvidence: "pkg/services/workers/internal/services/workstations/executor/script.go and pkg/services/recordings/internal/services/canonical_ledger/events/event_history.go RecordScriptEvent"},
		{Kind: recordings.FactoryEventTypeAgentRunResponse, EmissionEvidence: "pkg/services/workers/internal/services/workstations/executor/agentrun/events.go and pkg/services/recordings/internal/services/canonical_ledger/events/event_history.go RecordAgentRunEvent"},
