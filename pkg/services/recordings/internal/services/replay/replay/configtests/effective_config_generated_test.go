...
func embeddedFactoryDefinitions() []factoryConfigMutation {
	return []factoryConfigMutation{
		...
		withWorkstationDefinition("execute-story", func(workstation *interfaces.FactoryWorkstationConfig) {
			...
			workstation.Limits = interfaces.WorkstationLimits{MaxExecutionTime: "20m", MaxRetries: 2}
		}),
	}
}
