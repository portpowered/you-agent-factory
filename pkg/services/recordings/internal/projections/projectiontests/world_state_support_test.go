...
func generatedWorkDiagnosticsForProjectionTest(diagnostics *workerexecution.SafeWorkDiagnostics) *factoryapi.SafeWorkDiagnostics {
...
func TestReconstructFactoryWorldState_PreservesAgentRunInspectionDiagnostics(t *testing.T) {
	...
	if diagnostics.AgentRun.ToolPolicy != interfaces.AgentToolPolicyEnabled {
