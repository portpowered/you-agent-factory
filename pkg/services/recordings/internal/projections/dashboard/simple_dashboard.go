...
type SimpleDashboardRenderData = recordings.SimpleDashboardRenderData
type SimpleDashboardActiveExecution = recordings.SimpleDashboardActiveExecution
type SimpleDashboardWorkstationActivity = recordings.SimpleDashboardWorkstationActivity
type SimpleDashboardSessionData = recordings.SimpleDashboardSessionData
