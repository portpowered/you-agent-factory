...
func assertDynamicFanoutTransition(t *testing.T, outputNet *factoryruntime.Net) {
	t.Helper()
...
func assertDynamicFanoutTopology(t *testing.T, outputNet *factoryruntime.Net) {
	t.Helper()
...
func assertDynamicFanoutSpawnedBy(t *testing.T, outputNet *factoryruntime.Net) {
	t.Helper()
...
func assertDynamicFanoutParentArc(t *testing.T, parentArc factoryruntime.PetriArc) {
	t.Helper()
...
func assertDynamicFanoutCountArc(t *testing.T, countArc factoryruntime.PetriArc) {
	t.Helper()
	...
	matchGuard, ok := countArc.Guard.(*factoryruntime.PetriMatchColorGuard)
	if !ok {
...
func assertDynamicFanoutChildArc(t *testing.T, childArc factoryruntime.PetriArc) {
	t.Helper()
	...
	if childArc.Cardinality.Mode != factoryruntime.PetriCardinalityZeroOrMore {
		t.Errorf("arc[2] cardinality: expected ZERO_OR_MORE, got %d", childArc.Cardinality.Mode)
	}
	fcGuard, ok := childArc.Guard.(*factoryruntime.PetriFanoutCountGuard)
	if !ok {
