...
// TODO(P6-C): this compatibility survivor is retained for the Worker Sessions
// direct/child caller family; its successor is the detached Workers Execute
// boundary used by Runtime dispatch.
...
// TODO(P6-C): retain only for the Worker Sessions compatibility path until
// that caller family no longer needs workstation admission and cancellation.
...
// TODO(P6-C): retain this executor route only for the Worker Sessions
// direct/child compatibility caller family; the successor is detached
// provider policy carried through workers.Service.Execute.
