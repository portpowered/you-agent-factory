...
type Net struct {
	...
	// When the transitioner processes a generated Work Request batch from a
	// transition in this map, it creates a guard token in the count place
	// carrying the expected child count.
