...
func TestEdgesAggregateExactOwnerTypes(t *testing.T) {
	...
	expected := map[string]ownershipDecision{
		...
		"HostedHTTPClient":                                {typeName: "hostedlinear.HTTPDoer", effect: "send Linear GraphQL network requests"},
		"HostedLinearEndpoint":                            {typeName: "string", effect: "select the external Linear GraphQL endpoint"},
		"HostedSecretResolver":                            {typeName: "hostedlinear.SecretResolver", effect: "resolve the Linear credential at the hosted adapter"},
		"HostedLinearCheckpointStore":                     {typeName: "hostedlinear.CheckpointStore", effect: "persist hosted Linear resume checkpoints atomically"},
		"HostedClock":                                     {typeName: "hostedworkers.Clock", effect: "schedule hosted-poller waits"},
