...
func TestEdgesAggregateExactOwnerTypes(t *testing.T) {
	...
	expected := map[string]ownershipDecision{
		...
		"ProviderSessionFileSystem":                       {typeName: "providersessionswire.FileSystem", effect: "inspect and open provider-session storage"},
		"ProviderSessionResolveHomeDirectory":             {typeName: "providersessionswire.ResolveHomeDirectory", effect: "resolve default provider-session storage roots"},
		"ProviderSessionCodexWalkDirectory":               {typeName: "providersessionswire.CodexWalkDirectory", effect: "traverse Codex provider-session storage"},
		"ProviderSessionCodexResolveSymlinks":             {typeName: "providersessionswire.CodexResolveSymlinks", effect: "resolve Codex provider-session symlinks"},
		"ProviderSessionCursorWalkDirectory":              {typeName: "providersessionswire.CursorWalkDirectory", effect: "traverse Cursor provider-session storage"},
		"ProviderSessionCursorResolveSymlinks":            {typeName: "providersessionswire.CursorResolveSymlinks", effect: "resolve Cursor provider-session symlinks"},
		"ProviderSessionCursorOpenDatabase":               {typeName: "providersessionswire.CursorOpenSQLDatabase", effect: "open Cursor provider-session databases"},
		"ProviderSessionOperatingSystem":                  {typeName: "providersessionswire.OperatingSystem", effect: "select Cursor provider-session platform layout"},
