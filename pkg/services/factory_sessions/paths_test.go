...
func TestResolveSessionFolder_RequiresPath(t *testing.T) {
	_, err := ResolveSessionFolder("   ", os.UserHomeDir, localDirectoryInspection{})
	if err == nil {
...
func TestResolveSessionFolder_RejectsMissingDirectory(t *testing.T) {
	...
	_, err := ResolveSessionFolder(missing, os.UserHomeDir, localDirectoryInspection{})
	if err == nil {
...
func TestExpandFolderHome_ExpandsTildePrefix(t *testing.T) {
	...
	got, err := ExpandFolderHome("~/sessions/workspace", os.UserHomeDir)
	if err != nil {
...
func TestResolveSessionFolder_ExpandsTildeBeforeStat(t *testing.T) {
	...
	got, err := ResolveSessionFolder("~/session-root", os.UserHomeDir, localDirectoryInspection{})
	if err != nil {
...
type localDirectoryInspection struct{}

func (localDirectoryInspection) Stat(path string) (os.FileInfo, error)      { return os.Stat(path) }
func (localDirectoryInspection) ReadDir(path string) ([]os.DirEntry, error) { return os.ReadDir(path) }
