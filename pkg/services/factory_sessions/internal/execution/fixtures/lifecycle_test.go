...
func TestJavaScriptRuntimeService_CancelRunningSessionReturnsCanceling(t *testing.T) {
	service := newJavaScriptRuntimeServiceWithFixture(t, "busy-loop.workflow.js", "busy-loop", blockingFixtureWorkflows())
...
func TestJavaScriptRuntimeService_CancelTerminalSessionReturnsTypedControlError(t *testing.T) {
	service := newJavaScriptRuntimeServiceWithFixture(t, "simple-final.workflow.js", "simple-final", successfulFixtureWorkflows(map[string]any{"status": "done"}))
