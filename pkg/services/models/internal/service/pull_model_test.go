...
type stubPullModelHost struct {
	...
	gotRuntimeCfg  *modelRuntimeConfig
	gotModelName   string
}

func (h *stubPullModelHost) Pull(ctx context.Context, runtimeCfg *modelRuntimeConfig, modelName string) (modelhost.PullSnapshot, error) {
	h.gotContext = ctx
...
func (*stubPullModelHost) ResolveIdentity(context.Context, *modelRuntimeConfig, string) (modelhost.Identity, error) {
	return modelhost.Identity{}, nil
}

func (*stubPullModelHost) InspectReadiness(context.Context, *modelRuntimeConfig, string) (modelhost.ReadinessSnapshot, error) {
	return modelhost.ReadinessSnapshot{}, nil
}

func (*stubPullModelHost) AcquireLease(context.Context, *modelRuntimeConfig, string, modelhost.LeaseOptions) (modelhost.Lease, error) {
	return modelhost.Lease{}, nil
}

func (*stubPullModelHost) ReleaseLease(context.Context, string) error { return nil }

func (*stubPullModelHost) Unload(context.Context, *modelRuntimeConfig, string) error {
	return nil
}
...
func (p *stubPullAssetPuller) PullModel(context.Context, *modelRuntimeConfig, string) (apisurface.PullResult, error) {
