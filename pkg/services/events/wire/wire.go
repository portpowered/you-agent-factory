...
// NewService constructs an inert, process-scoped Events root. logger is
// optional and defaults to a no-op logger when omitted, matching the
// repository's optional-logger construction convention. Construction starts
// no background lifecycle work and performs no durable write.
