...
func TestMaterializedPackagedGoalFactory_AuthoredPromptSourcesMatchMaterializedFiles(t *testing.T) {
	...
	for _, source := range PackagedGoalRolePromptSources {
		...
		materializedPrompt, err := loadPackagedGoalRolePrompt(packagedGoalTestFileSystem, factoryDir, source)
		if err != nil {
...
func materializeAndLoadPackagedGoalFactory(
	t *testing.T,
) (string, interfaces.MutableLoadedFactorySource) {
	t.Helper()
...
func assertPackagedGoalSplitRolePromptRegression(
	t *testing.T,
	factoryDir string,
	...
	for _, source := range PackagedGoalRolePromptSources {
		...
		loadedPrompt, err := loadPackagedGoalRolePrompt(packagedGoalTestFileSystem, factoryDir, source)
		if err != nil {
...
func assertPackagedGoalLoadedPromptSurface(
	t *testing.T,
	loaded interfaces.MutableLoadedFactorySource,
...
func assertPackagedGoalLoadedWorkstationPrompt(
	t *testing.T,
	loaded interfaces.MutableLoadedFactorySource,
	source PackagedGoalRolePromptSource,
	wantPrompt string,
...
func assertPackagedGoalLoadedWorkerPrompt(
	t *testing.T,
	loaded interfaces.MutableLoadedFactorySource,
	source PackagedGoalRolePromptSource,
	wantPrompt string,
...
func loadedPackagedGoalRolePrompt(
	loaded interfaces.MutableLoadedFactorySource,
	source PackagedGoalRolePromptSource,
) (string, error) {
	switch source.SourceKind {
...
func loadedPackagedGoalWorkerBody(
	loaded interfaces.MutableLoadedFactorySource,
	workerName string,
) (string, bool) {
