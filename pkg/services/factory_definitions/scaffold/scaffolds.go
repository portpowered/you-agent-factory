...
type ScaffoldType = factorydefinitions.ScaffoldType

const (
	// DefaultScaffoldType is the existing single-step task-processing scaffold.
	DefaultScaffoldType = factorydefinitions.DefaultScaffoldType
	// RalphScaffoldType is the minimal PRD-to-execution scaffold.
	RalphScaffoldType = factorydefinitions.RalphScaffoldType

	// DefaultFactoryInputType is the work type created by the default scaffold.
	DefaultFactoryInputType = factorydefinitions.DefaultFactoryInputType
	// RalphFactoryInputType is the request intake work type for the Ralph scaffold.
	RalphFactoryInputType = factorydefinitions.RalphFactoryInputType
)
