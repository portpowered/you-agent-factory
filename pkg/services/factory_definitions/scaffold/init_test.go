...
const defaultProcessorSystemBody = "You are the processor. Complete the task."

var initDirs = []string{"workers", "workstations", "inputs"}
...
func assertRalphRuntimeConfig(t *testing.T, base string) {
	...
	loaded, err := factorydefinitioncomposition.LoadCurrent(base, nil)
	if err != nil {
