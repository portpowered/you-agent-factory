...
func generatedRunnerIDString(value string) string {
	return PermissivePublicFactoryRunnerID(workers.NormalizeRunnerID(value))
}
...
func GeneratedPublicFactoryRunnerID(value string) factoryapi.RunnerID {
	return factoryapi.RunnerID(PermissivePublicFactoryRunnerID(workers.NormalizeRunnerID(value)))
}
