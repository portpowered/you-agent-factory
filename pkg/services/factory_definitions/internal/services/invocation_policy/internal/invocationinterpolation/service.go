// Package invocationinterpolation implements Factory invocation interpolation
...
var _ factoryeffects.InvocationInterpolationService = Service{}

// NewService returns the canonical Factory invocation interpolator.
func NewService() factoryeffects.InvocationInterpolationService {
	return Service{}
}
...
func (Service) ValidateInvocationInterpolation(
	...
	readFile factoryeffects.FileReader,
) error {
...
func ValidateInvocationInterpolation(cfg *factorydefinitions.FactoryConfig, args *work.InvocationArguments, readFile factoryeffects.FileReader) error {
	if cfg == nil || args == nil {
		return nil
	}
...
func InterpolateWorkerConfig(worker factorydefinitions.FactoryWorkerConfig, args *work.InvocationArguments, readFile factoryeffects.FileReader) (factorydefinitions.FactoryWorkerConfig, error) {
	...
	if next.Provider, err = interpolateInvocationField(next.Provider, args, "worker.provider", false, readFile); err != nil {
		return factorydefinitions.FactoryWorkerConfig{}, err
	}
...
func InterpolateWorkstationConfig(workstation factorydefinitions.FactoryWorkstationConfig, args *work.InvocationArguments, readFile factoryeffects.FileReader) (factorydefinitions.FactoryWorkstationConfig, error) {
...
func validateInvocationOutputContract(output *work.InvocationOutputContractConfig, args *work.InvocationArguments, readFile factoryeffects.FileReader) error {
	if output == nil {
		return nil
	}
...
func invocationArgumentScalar(argument work.InvocationArgument, parameterName, fieldDescriptor string, readFile factoryeffects.FileReader) (string, error) {
	if len(argument.Values) != 1 {
		return "", &work.ArgumentError{
			Code:      factorydefinitions.ArgumentErrorCodeInvalidInterpolation,
...
func cloneWorkerForInterpolation(worker factorydefinitions.FactoryWorkerConfig) factorydefinitions.FactoryWorkerConfig {
