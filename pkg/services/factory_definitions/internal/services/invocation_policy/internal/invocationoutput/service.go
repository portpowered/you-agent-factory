// Package invocationoutput implements packaged invocation-output shaping policy
...
var _ factoryeffects.InvocationOutputShapingService = Service{}

// NewService returns the canonical packaged invocation-output shaper.
func NewService() factoryeffects.InvocationOutputShapingService {
	return Service{}
}
