...
import (
	...
	factorypersistence "github.com/portpowered/infinite-you/pkg/services/factory_definitions/internal/services/catalog/wire"
	"github.com/portpowered/infinite-you/pkg/services/factory_definitions/internal/services/distribution/internal/packageassets"
	packagedinstallation "github.com/portpowered/infinite-you/pkg/services/factory_definitions/internal/services/distribution/internal/packagedinstallation"
...
func packagedScriptsTestPersistence() factorydefinitions.Persistence {
	...
	persistence, err := factorypersistence.NewPersistence(
		validator,
