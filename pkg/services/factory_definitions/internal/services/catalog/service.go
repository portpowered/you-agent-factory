...
type Service interface {
	...
	ClearCurrentFactoryPointer(context.Context, factorydefinitions.ClearCurrentFactoryPointerRequest) (factorydefinitions.ClearCurrentFactoryPointerResult, error)
}
