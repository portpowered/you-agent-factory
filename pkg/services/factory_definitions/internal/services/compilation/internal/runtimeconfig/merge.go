...
func applyWorkstationRuntimeTemplate(
	...
	normalizeExecutionLimit(workstation)
...
// normalizeExecutionLimit canonicalizes the legacy workstation timeout while
// runtime configuration is merged. The invocation-policy service owns the
// public execution-timeout policy; compilation owns this pure normalization
// required to build an effective definition.
