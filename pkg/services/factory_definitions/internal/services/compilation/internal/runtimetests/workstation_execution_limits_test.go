...
import (
	...
	workstationexecution "github.com/portpowered/infinite-you/pkg/services/factory_definitions/internal/services/invocation_policy/wire"
)
...
func TestWorkstationExecutionTimeout_UsesCanonicalLimitOnly(t *testing.T) {
	...
	timeout, err := workstationexecution.NewWorkstationExecutionPolicy().ExecutionTimeout(cfg)
	if err != nil {
...
func TestWorkstationExecutionTimeout_ReturnsCanonicalParseError(t *testing.T) {
	...
	_, err := workstationexecution.NewWorkstationExecutionPolicy().ExecutionTimeout(cfg)
	if err == nil {
