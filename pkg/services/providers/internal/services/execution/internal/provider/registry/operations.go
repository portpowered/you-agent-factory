...
// RunnerIdentities returns selectable runner identities without exposing
// Providers registry entries across the Workers root boundary.
func (r *Registry) RunnerIdentities() []string {
	entries := r.Entries()
