// Package kiro owns the parent-private Kiro execution adapter.
package kiro
...
// Effect is the invocation-scoped native Kiro boundary. Implementations emit
...
// NewRegistration binds one Kiro effect to the canonical Kiro identity.
...
func newAttempt(effect Effect) execution.Attempt {
	...
	return func(
		...
		if sessionRef == nil {
			sessionRef = sessionRefFromOutput(stdout.Bytes(), nil, request.ResumeSession)
		}
...
func unavailableAttempt(
	...
	return providers.ExecuteResult{}, providers.ExecuteFailure{
		...
		Message: "Kiro native execution is unavailable",
	}
}
