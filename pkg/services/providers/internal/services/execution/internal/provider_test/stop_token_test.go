...
func TestContainsStopToken_Found(t *testing.T) {
	...
	if !workers.ContainsStopToken(output, "<promise>COMPLETE</promise>") {
...
func TestContainsStopToken_CaseSensitive(t *testing.T) {
	...
	if workers.ContainsStopToken(output, "COMPLETE") {
