...
func ProgressFragment(dispatchID string, providerSession *providers.SessionMetadata, payload string) InferenceProgressFragment {
	return InferenceProgressFragment{
		DispatchID:   strings.TrimSpace(dispatchID),
...
func ResponseFragment(dispatchID string, providerSession *providers.SessionMetadata, payload string) InferenceProgressFragment {
	return InferenceProgressFragment{
		DispatchID:   strings.TrimSpace(dispatchID),
...
func CompletedFragment(dispatchID string, providerSession *providers.SessionMetadata) InferenceProgressFragment {
	return InferenceProgressFragment{
		DispatchID:   strings.TrimSpace(dispatchID),
...
func FailedFragment(dispatchID string, providerSession *providers.SessionMetadata, payload string) InferenceProgressFragment {
	return InferenceProgressFragment{
		DispatchID:   strings.TrimSpace(dispatchID),
