...
type FinalOnlyFailureCase struct {
	...
	ExpectedProviderSession *providers.SessionMetadata
}
...
func assertFinalOnlySuccess(t *testing.T, fixture FinalOnlyFixture) {
	...
	if !sameProviderSession(gotSession, fixture.Expected.ProviderSession) {
...
func sameProviderSession(got, want *providers.SessionMetadata) bool {
	if got == nil || want == nil {
