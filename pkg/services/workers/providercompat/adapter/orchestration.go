...
type StreamingCommandRunner interface {
	Run(context.Context, workers.CommandRequest, func(Observation) error) (workers.CommandResult, error)
}
...
func commandOutcome(ctx context.Context, result workers.CommandResult, commandErr error) (CommandOutcome, FlushReason) {
