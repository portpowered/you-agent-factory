...
func providerFailureLogFields(
	...
	fields = appendProviderSessionLogFields(fields, (providerErr.Continuation).SessionMetadata())
...
func appendProviderSessionLogFields(fields []any, session *providers.SessionMetadata) []any {
	...
	return append(fields,
		"provider_session_provider", providers.ID(session.Provider).CanonicalSessionProvider(),
