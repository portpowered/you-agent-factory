...
// SafeWorkDiagnostics carries the canonical dashboard-safe execution diagnostics surface.
...
// WorkDiagnostics records worker-facing execution diagnostics before safe projection.
