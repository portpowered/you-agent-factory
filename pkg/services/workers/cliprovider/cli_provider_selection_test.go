	...
	return []cliProviderExplicitPrecedenceCase{
		{
			...
			input: CLIProviderSelectionInput{
				ExplicitInvocation: string(modelprovider.ProviderClaude),
				FactoryDefault:     string(modelprovider.ProviderCodex),
			},
		...
		},
		{
			...
			input: CLIProviderSelectionInput{
				ExplicitInvocation: string(modelprovider.ProviderGemini),
				SystemDefault:      string(modelprovider.ProviderCodex),
			},
			presentCommands: allPresent,
			wantSource:      CLIProviderSelectionSourceExplicitInvocation,
		...
		},
		{
			...
			input: CLIProviderSelectionInput{
				ExplicitInvocation: string(modelprovider.ProviderKiro),
				FactoryDefault:     string(modelprovider.ProviderCodex),
				SystemDefault:      string(modelprovider.ProviderClaude),
			},
			presentCommands: map[string]bool{
				string(modelprovider.ProviderCodex): true,
			},
		...
		},
		{
			...
			input: CLIProviderSelectionInput{
				ExplicitInvocation: workertaxonomy.WorkerModelProviderDefault,
				FactoryDefault:     string(modelprovider.ProviderCursor),
			},
			presentCommands: allPresent,
		...
		},
		{
			...
			input: CLIProviderSelectionInput{
				...
				SystemDefault:      string(modelprovider.ProviderGemini),
			},
			presentCommands: allPresent,
...
func fakeCLIProviderConfiguredDefaultPrecedenceCases() []cliProviderConfiguredDefaultPrecedenceCase {
	...
	return []cliProviderConfiguredDefaultPrecedenceCase{
		...
		},
		{
			...
			input: CLIProviderSelectionInput{
				FactoryDefault: string(modelprovider.ProviderKiro),
				SystemDefault:  string(modelprovider.ProviderClaude),
			},
			presentCommands: map[string]bool{
				string(modelprovider.ProviderCodex): true,
		...
		},
		{
			...
			input: CLIProviderSelectionInput{
				SystemDefault: string(modelprovider.ProviderOpenCode),
			},
			presentCommands: map[string]bool{
				string(modelprovider.ProviderCodex):  true,
				string(modelprovider.ProviderGemini): true,
...
func fakeCLIProviderNoAgentHarnessCases() []cliProviderNoAgentHarnessCase {
	return []cliProviderNoAgentHarnessCase{
		...
		},
		{
			...
			input: CLIProviderSelectionInput{
				ExplicitInvocation: "openai",
				FactoryDefault:     workertaxonomy.WorkerModelProviderDefault,
				SystemDefault:      "legacy-model-default",
			},
			presentCommands: map[string]bool{},
			wantGuidance: []string{
