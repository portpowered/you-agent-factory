...
type ModeParityOutcome struct {
	...
	StreamEvents          []factorysessions.FactoryResponseEvent
...
func ProjectResponseStreamInvocation(outcome TransportParityOutcome) ([]factorysessions.FactoryResponseEvent, factoryapi.InvocationResponse, error) {
