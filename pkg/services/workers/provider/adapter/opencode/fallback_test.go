...
func assertOnlyFinalSnapshotActivity(t *testing.T, drafts []factorysessions.ResponseEventDraft) {
	t.Helper()
	for _, draft := range drafts {
		if draft.Kind == factorysessions.ResponseEventKindTool || draft.Kind == factorysessions.ResponseEventKindReasoning || draft.Phase == factorysessions.ResponseEventPhaseDelta {
