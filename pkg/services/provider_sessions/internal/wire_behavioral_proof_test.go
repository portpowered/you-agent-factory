...
// TestWireBehavioralProof_PublishedRootPreservesCodexObservables constructs
// Provider Sessions exclusively through provider_sessions/wire and proves
// Details, Inspect, and Project preserve Codex-backed session identity and
// source metadata on the published providersessions.Service peer surface.
func TestWireBehavioralProof_PublishedRootPreservesCodexObservables(t *testing.T) {
...
// TestWireBehavioralProof_PublishedRootPreservesCursorObservables constructs
// Provider Sessions exclusively through provider_sessions/wire and proves
// Details, Inspect, and Project preserve Cursor provider identity, projection
// assertions, and non-empty source path metadata.
func TestWireBehavioralProof_PublishedRootPreservesCursorObservables(t *testing.T) {
...
// TestWireBehavioralProof_PublishedRootPreservesTypedLookupFailures constructs
// Provider Sessions exclusively through provider_sessions/wire and proves typed
// lookup failures and present-session Project sanity checks on the published
// providersessions.Service peer surface.
func TestWireBehavioralProof_PublishedRootPreservesTypedLookupFailures(t *testing.T) {
