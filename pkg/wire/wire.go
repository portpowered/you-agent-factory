...
var servicesSet = wire.NewSet(
	...
	wire.Struct(new(factorysessionwire.ProviderSessionsRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.FactoryRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.FactoryDefinitionsRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.FactorySessionsRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.WebhooksRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.WorkRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.AutomationsRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.ModelsRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.RecordingsRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.WorkersRuntimeOpeningDependencies), "*"),
	wire.Struct(new(factorysessionwire.OperatorSettingsRuntimeOpeningDependencies), "*"),
