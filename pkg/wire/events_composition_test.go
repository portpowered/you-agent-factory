...
func TestProvideApplicationProcessLifecycleSharesTheExactEventsInstance(t *testing.T) {
	...
	lifecycle, err := provideApplicationProcessLifecycle(providersService, &closingModelsService{}, eventsService, &closingFactorySessionsService{}, nil, &localWorkerSessionsBoundary{}, nil)
	if err != nil {
...
func TestProvideApplicationProcessLifecycleRequiresEventsLifecycle(t *testing.T) {
	...
	if _, err := provideApplicationProcessLifecycle(providersService, &closingModelsService{}, staticEventsServiceWithoutLifecycle{}, &closingFactorySessionsService{}, nil, &localWorkerSessionsBoundary{}, nil); err == nil {
