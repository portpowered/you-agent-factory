...
func TestProvideApplicationProcessLifecycleSharesTheExactEventsInstance(t *testing.T) {
	...
	lifecycle, err := provideApplicationProcessLifecycle(providersService, eventsService, nil, nil)
	if err != nil {
...
func TestProvideApplicationProcessLifecycleRequiresEventsLifecycle(t *testing.T) {
	...
	if _, err := provideApplicationProcessLifecycle(providersService, staticEventsServiceWithoutLifecycle{}, nil, nil); err == nil {
