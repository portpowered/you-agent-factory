...
func TestInternalHelperConversions(t *testing.T) {
	t.Run("session budgets", func(t *testing.T) {
	...
	t.Run("session usage", func(t *testing.T) {
	...
	t.Run("provider session refs", func(t *testing.T) {
...
func TestInternalProjectionHelpers(t *testing.T) {
	t.Run("result availability", func(t *testing.T) {
	...
	t.Run("dispatch usage warnings and failure", func(t *testing.T) {
	...
	t.Run("dispatch detail helpers", func(t *testing.T) {
