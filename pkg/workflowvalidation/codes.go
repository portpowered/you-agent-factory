...
const (
	CodeSyntaxError              = "workflow.source.syntaxError"
	CodeUnsupportedGlobal        = "workflow.source.unsupportedGlobal"
	CodeUnsupportedPrimitive     = "workflow.source.unsupportedPrimitive"
	CodeForbiddenHostAccess      = "workflow.source.forbiddenHostAccess"
