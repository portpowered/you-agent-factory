...
work types, states, workers, workstations, resources, routing, and portability.
...
that workstation routing refers to workers by name. Runner precedence across
those surfaces is explicit: workstation `runner`, then factory `runner`, then
