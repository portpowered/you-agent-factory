...
var topicDocuments = []topicDocument{
	{topic: TopicAgents, description: "Agent orientation: read order, work submission ingress, command matrix, and topic routing.", path: referenceAgentsPath, displayOrder: 5},
	...
	{topic: TopicConfig, description: "Factory.json topology: work types, states, routing, resources, and portability.", path: referenceConfigPath, displayOrder: 20},
	...
	{topic: TopicWork, description: "Submitted work contracts: POST /work, tags, tokens, and batch cross-links.", path: referenceWorkPath, displayOrder: 30},
