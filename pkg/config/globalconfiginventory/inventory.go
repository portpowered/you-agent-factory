...
// field topology and ownership split between operatorconfig and systemconfig without
...
const (
	ownerSystemconfig   = "systemconfig"
	ownerOperatorconfig = "operatorconfig"
	ownerNone           = "none"

	strictnessOperatorStrictDecode = "operatorconfig strict decode (DisallowUnknownFields on parse)"
	strictnessSystemTolerantLoad   = "systemconfig tolerant load (unknown top-level keys ignored on read; preserved on persist)"
...
// SharedFileSplit documents how two owner packages share one JSON file.
