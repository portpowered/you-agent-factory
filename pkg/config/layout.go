  ...
  "workstations": [
    {
      ...
      "body": "Plan the requested goal: {{ (index .Inputs 0).Payload }}"
    },
    {
      "name": "execute-goal",
      "type": "AGENT_RUN",
      ...
      "body": "Execute the planned goal for work {{ (index .Inputs 0).WorkID }}."
    },
    {
      "name": "check-goal",
      "type": "SCRIPT_RUN",
      ...
      "body": "Run verification checks for goal {{ (index .Inputs 0).WorkID }}."
    },
    {
    ...
    },
    {
      ...
      "body": "Review goal progress for {{ (index .Inputs 0).WorkID }}."
    },
    {
