...
func TestSharedScopedPaths(t *testing.T) {
	...
	if got, want := NamedFactoriesRoot(homeDir), filepath.Join(homeDir, ".you-agent-factory", "you-agent-factories"); got != want {
...
func TestRuntimeLogsDatedDirUsesUTCDayLayout(t *testing.T) {
	...
	if got, want := RuntimeLogsDatedDir(rootDir, at), filepath.Join(rootDir, "2026-05", "2026-05-22"); got != want {
