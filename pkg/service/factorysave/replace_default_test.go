...
func TestSaveDefaultCurrentFactoryForSession_RestoresTreeOnActivationFailure(t *testing.T) {
	...
	_, err := svc.Save(context.Background(), factorysessions.DefaultSessionID, factoryapi.FactorySaveModeReplaceCurrent, replacement)
	if err == nil {
...
func (h *splitLayoutDefaultSaveHost) ActivateSessionEditableFactory(context.Context, *factorysessions.LiveSession, string, string, string, factoryapi.FactoryName, string) error {
...
func (h *splitLayoutDefaultSaveHost) SessionRuntimeConfig(string) (*factoryconfig.LoadedFactoryConfig, error) {
	return nil, errors.New("not implemented")
}

func (h *splitLayoutDefaultSaveHost) SerializeNamedFactoryUpsertResponse(factoryapi.FactoryName, *factoryconfig.LoadedFactoryConfig) (factoryapi.Factory, error) {
