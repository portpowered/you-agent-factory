...
func TestCheckedInReplayInferenceFixtureDocumentsPromptExposure(t *testing.T) {
	fixture := testpath.MustRepoPathFromCaller(t, 0, "pkg", "factory", "replay", "testdata", "inference-events.replay.json")
...
func replayFixturePaths(t *testing.T) []string {
	...
	return existingFiles([]string{
		testpath.MustRepoPathFromCaller(t, 0, "pkg", "factory", "replay", "testdata", "inference-events.replay.json"),
