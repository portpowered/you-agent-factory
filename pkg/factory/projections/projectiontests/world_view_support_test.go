...
func TestBuildFactoryWorldView_MarshaledTopologySubmitWorkTypes(t *testing.T) {
	t0 := time.Date(2026, 4, 16, 8, 0, 0, 0, time.UTC)
...
func TestBuildFactoryWorldView_MarshaledCompletedRuntimeSession(t *testing.T) {
	t0 := time.Date(2026, 4, 16, 8, 0, 0, 0, time.UTC)
	events := canonicalDispatchProviderSessionProjectionEvents(t0)
...
func TestBuildFactoryWorldView_MarshaledActiveExecutionConsumedInputs(t *testing.T) {
	t0 := time.Date(2026, 4, 16, 8, 0, 0, 0, time.UTC)
	events := canonicalDispatchProviderSessionProjectionEvents(t0)
...
func TestBuildFactoryWorldView_MarshaledInferenceAttemptsByDispatch(t *testing.T) {
	t0 := time.Date(2026, 4, 16, 8, 0, 0, 0, time.UTC)
	exitCode := 1
