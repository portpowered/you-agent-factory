...
const (
	...
	// the canonical owner.
	providersExecutionCompatibilityPackage = "pkg/services/workers/providercompat/inferencecontract"
	...
	providersExecutionCompatibilityPrefix = "pkg/services/workers/providercompat/"
