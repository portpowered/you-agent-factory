...
func newTestProviderSessionService() { sessions.CanonicalProvider("agent"); service.NewForRoots(); cursor.LoadDetails(); providers.CanonicalProviderSessionProvider("agent") }
