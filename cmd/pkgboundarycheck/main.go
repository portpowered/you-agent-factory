...
var transportPrivateServiceSubpackages = []string{
	"pkg/services/factory_runtime/engine",
	"pkg/services/factory_runtime/runtime",
	"pkg/services/factory_runtime/scheduler",
	"pkg/services/factory_runtime/service",
	"pkg/services/factory_runtime/state",
	"pkg/services/factory_runtime/subsystems",
	"pkg/services/factory_runtime/throttle",
	"pkg/services/factory_runtime/token",
	"pkg/services/factory_runtime/token_transformer",
	"pkg/services/factory_sessions/runtime",
	"pkg/services/factory_sessions/runtimebinding",
	"pkg/services/factory_sessions/service",
...
var convergedServiceSubpackageRoots = map[string]string{
	...
	"pkg/services/factory_runtime/state":                       "factory_runtime",
	"pkg/services/factory_runtime/token":                       "factory_runtime",
	"pkg/services/factory_runtime/metrics":                     "factory_runtime",
	"pkg/services/factory_runtime/build":                       "factory_runtime",
	"pkg/services/factory_runtime/checkpointsummary":           "factory_runtime",
	"pkg/services/factory_runtime/context":                     "factory_runtime",
	"pkg/services/factory_runtime/definitionmapping":           "factory_runtime",
	"pkg/services/factory_runtime/engine":                      "factory_runtime",
	"pkg/services/factory_runtime/ingest":                      "factory_runtime",
	"pkg/services/factory_runtime/internal":                    "factory_runtime",
	"pkg/services/factory_runtime/orchestratorcontract":        "factory_runtime",
	"pkg/services/factory_runtime/replayhooks":                 "factory_runtime",
	...
	"pkg/services/factory_runtime/token_transformer":           "factory_runtime",
	"pkg/services/factory_runtime/tooling":                     "factory_runtime",
	"pkg/services/factory_sessions/invocation":                 "factory_sessions",
	"pkg/services/factory_sessions/cursors":                    "factory_sessions",
	"pkg/services/factory_sessions/execution":                  "factory_sessions",
	"pkg/services/factory_sessions/logicaltarget":              "factory_sessions",
	"pkg/services/factory_sessions/responseevents":             "factory_sessions",
	"pkg/services/factory_sessions/responseeventstore":         "factory_sessions",
	"pkg/services/factory_sessions/responsestream":             "factory_sessions",
	"pkg/services/factory_sessions/runtime":                    "factory_sessions",
	"pkg/services/factory_sessions/runtimebinding":             "factory_sessions",
...
var retiredPackageRoots = append([]retiredPackageRoot{
	...
	{packagePath: "pkg/sessionpersistence", canonicalOwner: "pkg/services/factory_sessions/cursors/persistence"},
	{packagePath: "pkg/services/provider_sessions/cursor/persistence", canonicalOwner: "pkg/services/factory_sessions/cursors/persistence"},
	{packagePath: "pkg/services/factory_sessions/execution/testharness", canonicalOwner: "owner-local _test.go construction in pkg/services/factory_sessions/execution"},
	...
	{packagePath: "pkg/services/provider_sessions/cursor/session", canonicalOwner: "pkg/services/factory_sessions/cursors"},
...
var approvedPeerServiceContractImports = map[string]struct{}{
	...
	"pkg/services/factory_sessions/execution\x00github.com/portpowered/infinite-you/pkg/services/workers/provider/inferencecontract":      {},
	"pkg/services/factory_sessions/runtimeopening\x00github.com/portpowered/infinite-you/pkg/services/workers/provider/inferencecontract": {},
	"pkg/services/factory_sessions/executionopening\x00github.com/portpowered/infinite-you/pkg/services/workers/agypty":                   {},
	"pkg/services/factory_sessions/runtimeopening\x00github.com/portpowered/infinite-you/pkg/services/workers/agypty":                     {},
