...
func TestRunRejectsRetiredDomainTransportMigrationFiles(t *testing.T) {
	...
	for _, path := range []string{
		"pkg/services/workers/providercompat/parityfixtures/mode_parity.go",
		"pkg/services/workers/providercompat/parityfixtures/suite.go",
		"pkg/services/workers/providercompat/parityfixtures/transport.go",
	} {
