...
func TestClassifyServicePackageRootVsNonRootForDistinctOwners(t *testing.T) {
	...
	cases := []struct {
		...
		{path: "pkg/services/workers/providercompat", owner: "providers", surface: surfaceNonRoot},
...
import (
  ...
  provider "github.com/portpowered/infinite-you/pkg/services/workers/providercompat"
