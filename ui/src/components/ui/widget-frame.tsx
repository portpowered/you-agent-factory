...
export const DETAIL_CARD_CLASS = cn(
  "[&_dd]:m-0 [&_dl]:m-0 [&_dl]:grid [&_dl]:gap-3 [&_dl_div:first-child]:border-t-0 [&_dl_div:first-child]:pt-0 [&_dl_div]:border-t [&_dl_div]:border-af-border [&_dl_div]:pt-3 [&_dt]:mb-1 [&_h3]:mt-0",
  DASHBOARD_SUPPORTING_LABELS_CLASS,
);
...
export const EMPTY_STATE_CLASS =
  "grid min-h-60 items-start gap-1.5 rounded-2xl border border-dashed border-af-border-strong bg-af-surface-subtle p-5 [&_h3]:m-0";
