...
export const Default = {
  ...
  play: async ({ canvasElement }: { canvasElement: HTMLElement }) => {
    ...
    await expect(
      canvas.getByRole("textbox", { name: "Request text" }),
    ).toBeVisible();
    await expect(
      canvas.getByRole("combobox", { name: "Work type" }),
    ).toBeVisible();
    await expect(
      canvas.getByRole("img", { name: "Primitive chart showcase" }),
    ).toBeVisible();
    await expect(
    ...
    await expect(
      canvas.getByRole("table", { name: "Primitive data table showcase" }),
    ).toBeVisible();
    await expect(
      canvas.getByLabelText("Primitive calendar showcase"),
    ).toBeVisible();
