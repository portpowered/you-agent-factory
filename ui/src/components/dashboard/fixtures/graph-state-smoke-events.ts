...
graphStateSmokeTimelineEvents[1].context.requestId =
  "request-smoke-complete-one";
graphStateSmokeTimelineEvents[1].context.traceIds = [
  "trace-smoke-complete-one",
];
graphStateSmokeTimelineEvents[1].context.workIds = ["work-smoke-complete-one"];
graphStateSmokeTimelineEvents[2].context.requestId =
  "request-smoke-complete-two";
graphStateSmokeTimelineEvents[2].context.traceIds = [
  "trace-smoke-complete-two",
];
...
graphStateSmokeTimelineEvents[4].context.dispatchId =
  "dispatch-smoke-complete-one";
graphStateSmokeTimelineEvents[4].context.traceIds = [
  "trace-smoke-complete-one",
];
graphStateSmokeTimelineEvents[4].context.workIds = ["work-smoke-complete-one"];
graphStateSmokeTimelineEvents[5].context.dispatchId =
  "dispatch-smoke-complete-one";
graphStateSmokeTimelineEvents[5].context.traceIds = [
  "trace-smoke-complete-one",
];
...
graphStateSmokeTimelineEvents[8].context.dispatchId =
  "dispatch-smoke-complete-two";
graphStateSmokeTimelineEvents[8].context.traceIds = [
  "trace-smoke-complete-two",
];
graphStateSmokeTimelineEvents[8].context.workIds = ["work-smoke-complete-two"];
graphStateSmokeTimelineEvents[9].context.dispatchId =
  "dispatch-smoke-complete-two";
graphStateSmokeTimelineEvents[9].context.traceIds = [
  "trace-smoke-complete-two",
];
