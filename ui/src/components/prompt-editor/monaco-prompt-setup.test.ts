// biome-ignore-all lint/style/noExcessiveLinesPerFile lint/complexity/noExcessiveLinesPerFunction: prompt completion contracts share a single Monaco API fixture vocabulary.
