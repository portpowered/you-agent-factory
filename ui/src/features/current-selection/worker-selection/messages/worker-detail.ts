...
const workerDetailMessagesByLocale = {
  en: {
    ...
    topologyDeleteAction: (workerName) => `Delete ${workerName} worker`,
    topologyDeleteBlockedPrefix: "Worker cannot be deleted:",
  ...
  ja: {
    ...
    summaryHeading: "概要",
    topologyDeleteAction: (workerName) => `ワーカー ${workerName} を削除`,
    topologyDeleteBlockedPrefix: "ワーカーを削除できません:",
  ...
  ko: {
    ...
    summaryHeading: "요약",
    topologyDeleteAction: (workerName) => `워커 ${workerName} 삭제`,
    topologyDeleteBlockedPrefix: "워커를 삭제할 수 없습니다:",
  ...
  "zh-CN": {
    ...
    summaryHeading: "摘要",
    topologyDeleteAction: (workerName) => `删除工作器 ${workerName}`,
    topologyDeleteBlockedPrefix: "无法删除工作器:",
