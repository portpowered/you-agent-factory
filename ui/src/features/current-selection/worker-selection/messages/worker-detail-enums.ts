...
const workerDetailEnumMessagesByLocale = {
  en: {
    ...
    localizeWorkerType: (value: string) =>
      localizeWorkerTypeLabel(value, "en", {
  ...
  ja: {
    ...
    localizeWorkerType: (value: string) =>
      localizeWorkerTypeLabel(value, "ja", {
  ...
  ko: {
    ...
    localizeWorkerType: (value: string) =>
      localizeWorkerTypeLabel(value, "ko", {
  ...
  "zh-CN": {
    ...
    localizeWorkerType: (value: string) =>
      localizeWorkerTypeLabel(value, "zh-CN", {
        AGENT_WORKER: "Agent worker",
...
function localizeWorkerTypeLabel(
  value: string,
  locale: string,
  labels: Record<string, string>,
): string {
  const catalog: EnumLabelCatalog<string> = {
    category: "kind",
    labels,
  };
  return Object.hasOwn(labels, value.trim())
    ? localizeEnumLabel({ ...catalog, locale, value })
    : value;
}
