...
function StatePositionWorkListItem({
    ...
    return (
      <li>
        <button
          ...
          className="grid w-full min-w-0 cursor-pointer gap-2 rounded-lg border border-af-border bg-af-surface-raised px-3 py-2 text-left outline-af-focus-ring transition hover:bg-af-overlay focus-visible:outline-2 focus-visible:outline-offset-2"
  ...
  return (
    <li className="grid min-w-0 gap-2 rounded-lg border border-af-border bg-af-surface-raised px-3 py-2 text-sm">
      {content}
    </li>
  );
}
