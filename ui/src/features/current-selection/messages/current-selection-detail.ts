...
const currentSelectionDetailMessagesByLocale = {
  en: {
    ...
    commandUnavailable: "Script command details are not available for this workstation request.",
    consumedWorkItemsLabel: "Consumed work items",
    dispatchIdLabel: "Dispatch ID",
    durationLabel: "Duration",
    durationUnavailable: "Duration details are not available for this script response yet.",
    ...
    failureMessageUnavailable: "Failure message is not available for this request.",
    failureReasonLabel: "Failure reason",
    failureReasonUnavailable: "Failure reason is not available for this request.",
    failureTypeLabel: "Failure type",
    failureTypeUnavailable: "Failure type is not available for this script response.",
    ...
    metadataEmpty: "Request metadata is not available for this workstation request.",
    modelLabel: "Model",
    ...
    requestIdUnavailable: "Request ID is not available for this workstation request.",
    ...
    selectWorkItemLabel: (workItemLabel: string) => `Select work item ${workItemLabel}`,
    ...
    workstationUnavailable: "Workstation details are not available for this request.",
  ...
  "zh-CN": {
    ...
    selectWorkItemLabel: (workItemLabel: string) => `选择工作项 ${workItemLabel}`,
