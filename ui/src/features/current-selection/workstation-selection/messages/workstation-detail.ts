...
const workstationDetailMessagesByLocale = {
  en: {
    ...
    runnerFieldHelp: (runnerName, sourceLabel) =>
      `Effective model provider: ${runnerName} (${sourceLabel}).`,
    ...
    runnerInheritanceFactoryLabel: (runnerName) =>
      `Inherit factory model provider (${runnerName})`,
    runnerInheritanceFactoryMissingLabel: "Inherit default model provider (Codex)",
    runnerLoadingValue: "Loading model provider...",
    ...
    selectedRunnerLabel: "Selected model provider",
    traceIdLabel: "Trace ID",
    unknownActiveWorkLabel: "Unknown active work",
    unavailableValue: "Unavailable",
    unavailableRunnerValue: "Model provider unavailable",
  ...
  ja: {
    ...
    runnerFieldHelp: (runnerName, sourceLabel) =>
      `有効な model provider: ${runnerName}（${sourceLabel}）。`,
    editableConfigurationCronExpiryWindowInvalid: (value) =>
      `expiry_window must be a positive duration, got ${JSON.stringify(value)}`,
    editableConfigurationCronJitterInvalid: (value) =>
      `jitter must be a non-negative duration, got ${JSON.stringify(value)}`,
    ...
    runnerFieldLabel: "Model provider",
    runnerInheritanceFactoryLabel: (runnerName) =>
      `ファクトリー model provider を継承 (${runnerName})`,
    runnerInheritanceFactoryMissingLabel: "既定 model provider (Codex) を継承",
    runnerLoadingValue: "model provider を読み込み中...",
    ...
    selectedRunnerLabel: "選択中の model provider",
    traceIdLabel: "トレース ID",
    unknownActiveWorkLabel: "不明なアクティブ作業",
    unavailableValue: "利用不可",
    unavailableRunnerValue: "model provider は利用できません",
  ...
  ko: {
    ...
    runnerFieldHelp: (runnerName, sourceLabel) =>
      `유효 model provider: ${runnerName} (${sourceLabel}).`,
    editableConfigurationCronExpiryWindowInvalid: (value) =>
      `expiry_window must be a positive duration, got ${JSON.stringify(value)}`,
    editableConfigurationCronJitterInvalid: (value) =>
      `jitter must be a non-negative duration, got ${JSON.stringify(value)}`,
    ...
    runnerFieldLabel: "Model provider",
    runnerInheritanceFactoryLabel: (runnerName) =>
      `팩토리 model provider 상속 (${runnerName})`,
    runnerInheritanceFactoryMissingLabel: "기본 model provider (Codex) 상속",
    runnerLoadingValue: "model provider 불러오는 중...",
    ...
    selectedRunnerLabel: "선택된 model provider",
    traceIdLabel: "추적 ID",
    unknownActiveWorkLabel: "알 수 없는 활성 작업",
    unavailableValue: "사용할 수 없음",
    unavailableRunnerValue: "model provider 를 사용할 수 없음",
  ...
  "zh-CN": {
    ...
    runnerFieldHelp: (runnerName, sourceLabel) =>
      `当前生效的 model provider：${runnerName}（${sourceLabel}）。`,
    editableConfigurationCronExpiryWindowInvalid: (value) =>
      `expiry_window must be a positive duration, got ${JSON.stringify(value)}`,
    editableConfigurationCronJitterInvalid: (value) =>
      `jitter must be a non-negative duration, got ${JSON.stringify(value)}`,
    ...
    runnerFieldLabel: "Model provider",
    runnerInheritanceFactoryLabel: (runnerName) =>
      `继承工厂 model provider（${runnerName}）`,
    runnerInheritanceFactoryMissingLabel: "继承默认 model provider（Codex）",
    runnerLoadingValue: "正在加载 model provider...",
    ...
    selectedRunnerLabel: "当前 model provider",
    traceIdLabel: "跟踪 ID",
    unknownActiveWorkLabel: "未知活动工作",
    unavailableValue: "不可用",
    unavailableRunnerValue: "model provider 不可用",
