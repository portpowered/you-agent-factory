...
import { sessionStreamToggleLabel } from "../../header/lib/dashboard-session-tabs-utils";
...
import { requireEventStream } from "./dashboard-session-stream-test-helpers";
...
describe("dashboard multi-session timeline switching", () => {
  registerAppDashboardTestLifecycle();
...
describe("dashboard multi-session timeline action isolation", () => {
  registerAppDashboardTestLifecycle();
