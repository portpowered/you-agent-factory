// biome-ignore-all lint/style/noExcessiveLinesPerFile: replay wiring cases share canonical event fixtures and one dashboard lifecycle.
// biome-ignore-all lint/complexity/noExcessiveLinesPerFunction: replay wiring cases share canonical event fixtures and one dashboard lifecycle.
import {
  act,
  fireEvent,
  screen,
...
import { renderDashboardScreen as renderApp } from "./testing/dashboard-screen-test-render";
