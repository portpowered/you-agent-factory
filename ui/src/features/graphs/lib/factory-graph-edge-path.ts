...
function positionVector(position: Position): FactoryGraphEdgeWaypoint {
  switch (position) {
    case Position.Left:
      return { x: -1, y: 0 };
    case Position.Right:
...
function pointDistance(
  first: FactoryGraphEdgeWaypoint,
  second: FactoryGraphEdgeWaypoint,
): number {
...
function compactConsecutiveRoutePoints(
  ...
  const compacted: FactoryGraphEdgeWaypoint[] = [];
...
function virtualEndpoint(input: {
  direction: FactoryGraphEdgeWaypoint;
  from: FactoryGraphEdgeWaypoint;
  mode: "after" | "before";
  neighbor: FactoryGraphEdgeWaypoint;
}): FactoryGraphEdgeWaypoint {
...
function catmullRomTangent(input: {
  current: FactoryGraphEdgeWaypoint;
  next: FactoryGraphEdgeWaypoint;
  previous: FactoryGraphEdgeWaypoint;
  tCurrent: number;
  tNext: number;
  tPrevious: number;
}): FactoryGraphEdgeWaypoint {
