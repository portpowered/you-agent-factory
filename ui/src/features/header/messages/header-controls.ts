...
const headerControlsMessagesByLocale = {
  en: {
    ...
    streamStatusConnectingLabel: "Event stream connecting",
    streamStatusLiveLabel: "Event stream live",
    streamStatusOfflineLabel: "Event stream offline",
  ...
  ko: {
    ...
    sliderLabel: "타임라인 틱",
    streamStatusConnectingLabel: "이벤트 스트림에 연결 중",
    streamStatusLiveLabel: "이벤트 스트림이 라이브 상태입니다",
    streamStatusOfflineLabel: "이벤트 스트림이 오프라인 상태입니다",
  ...
  "zh-CN": {
    ...
    sliderLabel: "时间线刻度",
    streamStatusConnectingLabel: "事件流正在连接",
    streamStatusLiveLabel: "事件流在线",
    streamStatusOfflineLabel: "事件流离线",
