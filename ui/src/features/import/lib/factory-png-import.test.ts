// biome-ignore-all lint/nursery/noExcessiveLinesPerFile lint/complexity/noExcessiveLinesPerFunction: fixture-heavy PNG import coverage stays consolidated while this migration only changes feature structure.
