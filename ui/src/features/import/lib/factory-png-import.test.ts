// biome-ignore-all lint/style/noExcessiveLinesPerFile lint/complexity/noExcessiveLinesPerFunction: fixture-heavy PNG import coverage stays consolidated while this migration only changes feature structure.
