...
const INLINE_ADD_WIDGET_SURFACE_CLASS =
  "grid h-full min-h-0 gap-3 rounded-2xl border border-dashed border-af-overlay/18 bg-linear-to-br from-af-overlay/4 via-transparent to-af-overlay/8 p-4 text-left";
