// biome-ignore-all lint/nursery/noExcessiveLinesPerFile: existing factory-graph draft coverage stayed intact during feature-root migration.
// biome-ignore-all lint/complexity/noExcessiveLinesPerFunction: existing factory-graph draft coverage stayed intact during feature-root migration.
