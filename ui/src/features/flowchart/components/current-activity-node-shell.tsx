...
/** Localized copy for z-axis incomplete connection hints (Continue/Reject slots). */
export interface ZAxisIncompleteHints {
  accessibleLabel: string;
  title: string;
}

/** Right-rail anchor order on workstation nodes (matches factory graph connection anchors). */
