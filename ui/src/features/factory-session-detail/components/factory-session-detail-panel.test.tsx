// biome-ignore-all lint/nursery/noExcessiveLinesPerFile: dispatch drilldown coverage shares one panel fetch harness with boundary cases.
// biome-ignore-all lint/complexity/noExcessiveLinesPerFunction: dispatch drilldown coverage shares one panel fetch harness with boundary cases.
