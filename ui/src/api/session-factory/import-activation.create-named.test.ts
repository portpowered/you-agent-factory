...
describe("session factory import activation create-new-named drifted imported payload name", () => {
  it("persists the chosen createFactoryName when the imported payload name would otherwise drift", async () => {
    const fetchMock = vi
      .fn()
      .mockResolvedValueOnce(
        new Response(
