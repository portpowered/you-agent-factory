...
export interface components {
    schemas: {
        ...
        FactorySessionDispatchSummary: {
             ...
             */
            attempt?: number;
            /** @description Selected model provider when applicable. */
            modelProvider?: components["schemas"]["WorkerModelProvider"];
        ...
        FactoryWorldSelectedModelProviderView: {
            modelProvider?: components["schemas"]["WorkerModelProvider"];
            displayName?: string;
            modelProviderSelectionSource?: components["schemas"]["ModelProviderSelectionSource"];
        ...
        FactoryWorldWorkstationRequestRequestView: {
            modelProvider?: components["schemas"]["FactoryWorldSelectedModelProviderView"];
            /** Format: date-time */
            startedAt?: string;
        ...
        Factory: {
            ...
            id?: string;
            /** @description Default execution-family selection for the factory when a workstation or worker does not declare a concrete provider. DEFAULT defers to worker modelProvider and then the operator default. */
            modelProvider?: components["schemas"]["ModelProviderSelection"];
        ...
        /**
         * @description Canonical execution-family selector for factory-level defaults. DEFAULT defers to worker modelProvider and then the operator default.
         * @enum {string}
         */
        ModelProviderSelection: ModelProviderSelection;
        /**
         * @description Configuration layer that supplied the resolved model provider selection for a dispatch.
         * @enum {string}
         */
        ModelProviderSelectionSource: ModelProviderSelectionSource;
        /**
        ...
        Workstation: {
            ...
            worker: string;
            /** @description Optional workstation-specific execution-family override. When omitted or DEFAULT, dispatch defers to the factory modelProvider, then worker modelProvider, then the operator default. */
            modelProvider?: components["schemas"]["ModelProviderSelection"];
...
export const ModelProviderSelection = {
    // Defer execution-family selection to worker modelProvider, then operator default.
    ModelProviderSelectionDefault: "DEFAULT",
    // Claude model execution routed through the `claude` provider command.
    ModelProviderSelectionClaude: "CLAUDE",
    // Codex model execution routed through the `codex` provider command.
    ModelProviderSelectionCodex: "CODEX",
    // Cursor model execution routed through the `agent` provider command.
    ModelProviderSelectionCursor: "CURSOR",
    // Gemini model execution routed through the `gemini` provider command.
    ModelProviderSelectionGemini: "GEMINI",
    // Kiro model execution routed through the `kiro-cli` provider command.
    ModelProviderSelectionKiro: "KIRO",
    // OpenCode model execution routed through the `opencode` provider command.
    ModelProviderSelectionOpenCode: "OPENCODE",

} as const;
export type ModelProviderSelection = (typeof ModelProviderSelection)[keyof typeof ModelProviderSelection];
export const ModelProviderSelectionSource = {
    // Workstation-level modelProvider override resolved the dispatch target.
    workstation: "workstation",
    // Factory-level default modelProvider resolved the dispatch target.
    factory: "factory",
    // Worker modelProvider resolved the dispatch target when no explicit override is set.
    worker: "worker",
    // The operator default model provider resolved the dispatch target.
    operator_default: "operator_default",

} as const;
export type ModelProviderSelectionSource = (typeof ModelProviderSelectionSource)[keyof typeof ModelProviderSelectionSource];
