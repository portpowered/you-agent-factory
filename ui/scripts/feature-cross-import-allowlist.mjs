...
// Remove each entry in the same change that routes reuse through the target feature public/ boundary.
export const allowlistedCrossFeatureBoundaryViolations = [
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/base/components/detail-card-save-test-helpers.ts",
  },
  {
    importSpecifiers: [
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/base/components/detail-card-types.ts",
  },
  {
    importSpecifiers: [
      "../../../factory-graph-editor/lib/factory-graph-topology-impact",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
  ...
  {
    importSpecifiers: [
      "../../../factory-graph-editor/lib/graph-document-save-notifications",
      "../../../notifications/lib/save-notification-delivery-policy",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/base/messages/current-selection-save-toast.ts",
  },
  {
    importSpecifiers: [
      "../../../current-factory-definition/hooks/useFactoryDocumentSave",
  ...
  {
    importSpecifiers: [
      "../../../factory-graph-editor/lib/factory-graph-draft-types",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/components/current-selection-widget-save-notifications.tsx",
  },
  {
    importSpecifiers: [
      "../../provider-session-detail/lib/provider-session-ref",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/components/current-selection-widget.tsx",
  },
  {
    importSpecifiers: [
      "../../../provider-session-detail/lib/provider-session-ref",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/dispatch-selection/components/selected-work-dispatch-history-card.tsx",
  },
  {
    importSpecifiers: [
      "../../../provider-session-detail/lib/provider-session-ref",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/hooks/useCurrentSelection.actions.ts",
  },
  {
    importSpecifiers: ["../../terminal-work/lib/types"],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/hooks/useCurrentSelection.selection-helpers.ts",
  },
  {
    importSpecifiers: [
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/hooks/useCurrentSelection.ts",
  },
  {
    importSpecifiers: [
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/work-selection/components/inference-attempt-provider-session.tsx",
  },
  {
    importSpecifiers: [
      "../../../provider-session-detail/lib/provider-session-ref",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/work-state-selection/hooks/use-save-editable-work-state-configuration.ts",
  },
  {
    importSpecifiers: [
      "../../../current-factory-definition/lib/work-state-editable-values",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/workstation-selection/components/workstation-guards-field.tsx",
  },
  {
    importSpecifiers: [
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/workstation-selection/components/workstation-input-guards-field.tsx",
  },
  {
    importSpecifiers: [
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/workstation-selection/components/workstation-runner-field.tsx",
  },
  {
    importSpecifiers: [
      "../../../current-factory-definition/lib/workstation-worker-assignment",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/workstation-selection/components/workstation-summary-field-values.ts",
  },
  {
    importSpecifiers: [
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/workstation-selection/lib/detail-card-types.ts",
  },
  {
    importSpecifiers: [
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/workstation-selection/lib/editable-workstation-configuration-validation.ts",
  },
  {
    importSpecifiers: [
      "../../../current-factory-definition/lib/workstation-editable-values",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/workstation-selection/lib/workstation-editable-validation.ts",
  },
  {
    importSpecifiers: [
      "../../../current-factory-definition/lib/workstation-guards",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/current-selection/workstation-selection/lib/workstation-guard-row-keys.ts",
  },
  {
    importSpecifiers: [
      "../../../current-factory-definition/lib/workstation-guards",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/dashboard/hooks/useFactoryEventStream.fixtures.ts",
  },
  {
    importSpecifiers: ["../../timeline/state/factoryTimelineDebug"],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath: "src/features/dashboard/hooks/useFactoryEventStream.ts",
  },
  {
    importSpecifiers: [
      "../../current-factory-definition/hooks/useCurrentFactoryDefinition",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/components/factory-graph-editor-add-dialog.tsx",
  },
  {
    importSpecifiers: [
      "../../current-factory-definition/lib/workstation-behavior",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/components/factory-graph-editor-add-workstation-fields.tsx",
  },
  {
    importSpecifiers: [
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/components/factory-graph-editor-flow.tsx",
  },
  {
    importSpecifiers: [
      "../../current-selection/base/hooks/factory-document-save-types",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/lib/factory-graph-customer-display.ts",
  },
  {
    importSpecifiers: [
      "../../current-factory-definition/lib/workstation-worker-assignment",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/lib/factory-graph-draft-validation.ts",
  },
  {
    importSpecifiers: [
      "../../current-factory-definition/lib/editable-workstation-cron-validation",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/lib/factory-graph-editor-additions.ts",
  },
  {
    importSpecifiers: [
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/lib/factory-graph-editor-connections.ts",
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/lib/factory-graph-editor-layout.ts",
  },
  {
    importSpecifiers: [
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/lib/factory-graph-react-flow-projection.ts",
  },
  {
    importSpecifiers: [
      "../../flowchart/components/current-activity-node-chrome",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/lib/factory-graph-work-state-phase-styling.ts",
  },
  {
    importSpecifiers: [
      "../../current-factory-definition/lib/workstation-progress-outcome-routes",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/lib/factory-graph-workstation-connection-context.ts",
  },
  {
    importSpecifiers: [
      "../../current-factory-definition/lib/workstation-progress-outcome-routes",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/factory-graph-editor/lib/factory-validation-graph-projection.ts",
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/lib/factory-graph-draft-types",
      "../../factory-graph-editor/lib/factory-graph-work-state-phase-styling",
      "../../workflow-activity/messages/activity-shell",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/flowchart/components/current-activity-workstation-node.tsx",
  },
  {
    importSpecifiers: [
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/trace-drilldown/components/trace-dispatch-factory-graph-node.tsx",
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/lib/factory-graph-draft-types",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/trace-drilldown/components/trace-relation-factory-graph-node.tsx",
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/components/factory-graph-editor-edge",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/trace-drilldown/components/trace-relation-flow.tsx",
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/components/factory-graph-editor-edge",
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/trace-drilldown/components/trace-workstation-path.tsx",
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/lib/factory-graph-draft-types",
  ...
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/lib/factory-graph-draft-types",
      "../../factory-graph-editor/lib/factory-graph-react-flow-projection",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
  ...
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/lib/factory-graph-draft-types",
      "../../factory-graph-editor/lib/factory-graph-editor-layout",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
  ...
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/lib/factory-graph-work-state-phase-styling",
      "../../factory-graph-editor/lib/factory-graph-work-state-type",
  ...
  },
  {
    importSpecifiers: [
      ...
      "../../factory-graph-editor/components/factory-graph-editor-controls",
      "../../factory-graph-editor/lib/factory-graph-draft-types",
      "../../factory-graph-editor/lib/factory-graph-editor-connections",
      "../../factory-graph-editor/messages/editor",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/workflow-activity/hooks/observe-mode-factory-definition.ts",
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/components/factory-graph-editor-controls",
  ...
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/hooks/use-editable-factory-graph-types",
      "../../factory-graph-editor/hooks/use-factory-validation",
      "../../factory-graph-editor/lib/factory-graph-draft-apply",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
  ...
  },
  {
    importSpecifiers: [
      ...
      "../../factory-graph-editor/hooks/use-editable-factory-graph-types",
      "../../factory-graph-editor/lib/factory-graph-draft-types",
      "../../factory-graph-editor/lib/factory-graph-editor-removals",
    ],
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
  ...
  {
    importSpecifiers: [
      "../../factory-graph-editor/lib/factory-graph-customer-display",
      "../../factory-graph-editor/lib/factory-graph-draft-graph",
      "../../factory-graph-editor/lib/factory-graph-draft-types",
      "../../factory-graph-editor/lib/factory-graph-node-class-visibility",
      "../../factory-graph-editor/messages/editor",
  ...
  },
  {
    ...
    reason:
      "Legacy cross-feature internal import. Route reuse through the target feature public/ boundary or relocate shared behavior.",
    relativeFilePath:
      "src/features/workflow-activity/lib/migrate-work-state-graph-layout-positions.ts",
  },
  {
    importSpecifiers: [
      "../../factory-graph-editor/lib/factory-graph-draft-types",
  ...
  },
  {
    importSpecifiers: [
      ...
      "../../factory-graph-editor/lib/factory-graph-draft-types",
      "../../factory-graph-editor/lib/factory-graph-editor-connections",
      "../../factory-graph-editor/lib/factory-graph-progress-outcome-handle-visibility",
      "../../factory-graph-editor/lib/factory-validation-graph-projection",
      "../../factory-graph-editor/messages/editor",
      "../../flowchart/components/current-activity-node-shell",
      "../../flowchart/lib/layout",
    ],
