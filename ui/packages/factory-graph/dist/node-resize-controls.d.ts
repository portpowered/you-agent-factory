...
export declare function FactoryGraphNodeResizeControls({ allowedAxes, bounds, isVisible, nodeId, onResize, onResizeEnd, }: FactoryGraphNodeResizeControlsProps): import("react/jsx-runtime").JSX.Element | null;
