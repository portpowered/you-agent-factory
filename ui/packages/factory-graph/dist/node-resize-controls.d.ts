...
export declare function FactoryGraphNodeResizeControls({ allowedAxes, bounds, isVisible, nodeId, onResizeEnd, }: FactoryGraphNodeResizeControlsProps): import("react").JSX.Element | null;
