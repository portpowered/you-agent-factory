...
export function FactoryGraphNodeShell({ children, className = "", handles, interactionOverlay, nodeType, resizeControls, visualState: visualStateInput, zAxisIncompleteHints = null, }) {
    ...
    return (_jsxs("div", { className: "relative h-full min-w-0 w-full", children: [_jsxs(GraphNodeShell, { "aria-invalid": visualState.validation === "error" || undefined, className: classNames("shadow-none", nodeType === "workstation" &&
