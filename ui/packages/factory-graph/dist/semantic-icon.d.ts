export declare const GRAPH_SEMANTIC_ICON_KINDS: readonly ["queue", "processing", "terminal", "failed", "resource", "worker", "work-type", "constraint", "doc", "limit", "workstation", "repeater", "cron", "poller", "active-work"];
