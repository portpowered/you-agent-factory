export declare const GRAPH_SEMANTIC_ICON_KINDS: readonly ["queue", "processing", "terminal", "failed", "resource", "worker", "script", "codex", "claude", "gemini", "antigravity", "work-type", "constraint", "doc", "limit", "workstation", "repeater", "cron", "poller", "active-work"];
