...
16.1. If there is no existing PR and all tasks in the current PRD are complete, create the PR for the branch, named pss-del-def. Set the description as the prd.json file that we used.
