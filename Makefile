...
provider-parity-smoke:
	$(GO) test ./pkg/services/workers/providercompat/paritytests -run $(CROSS_PROVIDER_PARITY_SMOKE_TEST) -count=1 -timeout $(CROSS_PROVIDER_PARITY_SMOKE_TIMEOUT)
