...
packaged-factory-package-smoke: packaged-factory-catalog-check
	node --test scripts/packaged-factories-package-contract.test.mjs scripts/packaged-factories-package-pack.test.mjs scripts/packaged-factories-package-candidate.test.mjs
