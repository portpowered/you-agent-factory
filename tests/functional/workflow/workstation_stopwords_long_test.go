...
func TestWorkstationStopWords_FactoryJSON_Success(t *testing.T) {
	...
	provider := testutil.NewMockProvider(
		workerexecution.InferenceResponse{Content: "Work completed successfully. COMPLETE"},
	)
...
func TestWorkstationStopWords_FactoryJSON_SecondWord(t *testing.T) {
	...
	provider := testutil.NewMockProvider(
		workerexecution.InferenceResponse{Content: "All tasks finished. DONE"},
	)
	h := testutil.NewServiceTestHarness(t, dir,
		testutil.WithProvider(provider),
		testutil.WithFullWorkerPoolAndScriptWrap(),
...
func TestWorkstationStopWords_FactoryJSON_Failure(t *testing.T) {
	...
	provider := testutil.NewMockProvider(
		workerexecution.InferenceResponse{Content: "I tried but could not finish the work"},
	)
	h := testutil.NewServiceTestHarness(t, dir,
		testutil.WithProvider(provider),
		testutil.WithFullWorkerPoolAndScriptWrap(),
...
func TestWorkstationStopWords_Override_StationAcceptsWorkerRejects(t *testing.T) {
	...
	provider := testutil.NewMockProvider(
		workerexecution.InferenceResponse{Content: "The work is finished. STATION_COMPLETE"},
	)
	h := testutil.NewServiceTestHarness(t, dir,
		testutil.WithProvider(provider),
		testutil.WithFullWorkerPoolAndScriptWrap(),
...
func TestWorkstationStopWords_Override_StationRejectsWorkerAccepts(t *testing.T) {
	...
	provider := testutil.NewMockProvider(
		workerexecution.InferenceResponse{Content: "The work is done. WORKER_COMPLETE"},
	)
	h := testutil.NewServiceTestHarness(t, dir,
		testutil.WithProvider(provider),
		testutil.WithFullWorkerPoolAndScriptWrap(),
...
func TestWorkstationStopWords_Override_BothMatch(t *testing.T) {
	...
	provider := testutil.NewMockProvider(
		workerexecution.InferenceResponse{Content: "WORKER_COMPLETE and STATION_COMPLETE"},
	)
	h := testutil.NewServiceTestHarness(t, dir,
		testutil.WithProvider(provider),
		testutil.WithFullWorkerPoolAndScriptWrap(),
