...
func TestMain(m *testing.M) {
	...
	fmt.Fprintf(
		os.Stderr,
		"CHAR-001 ledger root_builds=%d api_servers=%d httptest_servers=%d localai_starts=%d tcp_listeners=%d host_starts=%d asset_http_calls=%d host_http_calls=%d local_http_calls=%d\n",
