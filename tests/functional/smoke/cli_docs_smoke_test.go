...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "loop", heading: "# Recurring Loop Factory", markers: []string{"@you/loop", "you config init", "you run --named @you/loop", "--period", "1h", "24h", "--worktree", "nonempty relative worktree name", "--default-worker-model-provider", "file < env < flag", "you session list", "you session show <session-id>", "you session delete <session-id>", "Validation failures", "A worker\nexecution failure", "make docs-reference-smoke"}},
