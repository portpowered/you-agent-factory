...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "packaged-goal", heading: "# Packaged Goal (`@you/goal`)", markers: []string{"you run --named @you/goal", "browser or dashboard interaction", "primaryResult", "invocationReturn", "avoids binding a localhost API listener", "goal-executor", "execute-goal", "~/.you-agent-factory/factories", "@you%2Fgoal", "INVOCATION_INPUT_SOURCE_CONFLICT", "INVOCATION_BLOCKED", "INVOCATION_NEEDS_HUMAN", "INVOCATION_PAUSED", "INVOCATION_INTERRUPTED", "INVOCATION_RUNTIME_FAILURE", "INVOCATION_TIMED_OUT", "INVOCATION_PRIMARY_RESULT_UNRESOLVED", "sessionId", "workId", "workState", "you session resume <session-id>", "make docs-reference-smoke", "editable", "invocation-return contract", "`you docs authoring-factories`", "`you docs config`", "`you docs sessions`", "`you docs workstations`", "`you docs workers`", "## Goal flow topology", "multi-stage flow", "plan-goal", "check-goal", "review-goal", "structured-review-goal", "goal:init", "goal:plan", "goal:execute", "goal:complete", "goal:blocked", "goal:needs-human", "goal:interrupted", "goal:failed", "## Inspect-first recovery flow", "FactorySession", "goal-planner/AGENTS.md", "structured-review-goal/AGENTS.md", "does not add `/goal/inspect`"}, absent: []string{"[Authoring Factories](authoring-factories.md)", "[Config](config.md)", "[Sessions](sessions.md)", "MODEL_WORKER", "MODEL_WORKSTATION", "Workstation.workPropagation is absent", "does not carry invocationReturn", "automatic JSON detection"}},
