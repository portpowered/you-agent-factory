...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "batch-inputs", heading: "# Batch Inputs", markers: []string{"FACTORY_REQUEST_BATCH", "DEPENDS_ON", "PARENT_CHILD", "factory/inputs/BATCH/default/<request_id>.json", "you docs relationships", "[Relationships](relationships.md)", "[Guards](guards.md)"}, absent: []string{"../internal/development/parent-aware-fan-in.md"}},
