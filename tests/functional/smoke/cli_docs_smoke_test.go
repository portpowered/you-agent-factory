...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "run", heading: "# Run", markers: []string{"you run", "Factory", "Factory Session", "you docs config", "you docs sessions"}},
