...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "claude-dynamic-workflows", heading: "# Dynamic Workflows (`Workflow` tool) — Reference", markers: []string{"Compatibility snapshot", "## 2. Top-level tool payload", "resumeFromRunId", "## 4. Core functions", "agent(prompt, opts?)", "pipeline(items", "parallel(thunks)", "workflow(nameOrRef", "## 12. Quick capability checklist", "JavaScript workflows"}},
