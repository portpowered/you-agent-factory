...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "providers", heading: "# Providers and ACP Agents", markers: []string{"executorProvider", "cursor-acp", "kiro-acp", "opencode-acp", "you workers acp list", "you workers acp add", "you workers acp delete", "~/.you-agent-factory/config.json", "skipPermissions", "you factory config validate", "--output response-stream", "@you/goal", "agent.run", "you docs javascript-workflows", "Factory validation checks configuration shape"}},
