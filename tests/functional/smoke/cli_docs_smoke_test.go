...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "authoring-factories", heading: "# Authoring Factories", markers: []string{"factory.json", "workers/<name>/AGENTS.md", "workstations/<name>/AGENTS.md", "you run --factory ./factory.json \"Fix the lint issues\"", "handlingBehavior: [\"DEFAULT\"]", "you run --dir ./factory --with-mock-workers --work ./docs/examples/startup-work.json", "you docs mock-workers", "you docs record-replay", "you docs run", "you docs models", "you run --named @you/goal", "you run --named @you/tts --output primary \"Read the release summary.\"", "`you docs agents`", "--no-record", "requestId", "workTypeName", "~/.you-agent-factory/factories", "you factory list --dir ~/.you-agent-factory/factories", "~/.you-agent-factory/factories/@you/review", "you factory config validate ~/.you-agent-factory/factories/@you/review", "On upgrade, `you config init` moves valid factories"}, absent: []string{"work_type_name", "source_work_name", `"request_id"`, "[Agents](agents.md)", "you docs packaged-fusion", "you docs packaged-goal", "you docs packaged-tts", "~/.you-agent-factory/you-agent-factories/@you/review", "you factory config validate ~/.you-agent-factory/you-agent-factories/@you/review"}},
