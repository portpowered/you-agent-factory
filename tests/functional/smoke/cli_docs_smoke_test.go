...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "providers", heading: "# Providers and ACP Agents", markers: []string{"you providers list", "you providers list --json", "availability`, `readiness`, and `prerequisites", "models` and `efforts", "Directional input/output support", "knownLimits", "gpt-5.6", "referenced_image_paths", "antigravity", "claude-opus-4-6-thinking", "file_path", "--add-dir", "print_timeout", "executorProvider", "modelProvider", "cursor-acp", "kiro-acp", "opencode-acp", "you workers list", "you workers acp add", "you workers acp delete", "~/.you-agent-factory/config.json", "skipPermissions", "you factory config validate", "--provider cursor-acp", "@you/goal", "agent.run", "you docs javascript-workflows", "Factory validation checks configuration shape"}},
