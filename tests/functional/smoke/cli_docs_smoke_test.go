...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "packaged-goal", heading: "# Packaged Goal (`@you/goal`)", markers: []string{"you run --named @you/goal", "MODEL_WORKER", "MODEL_WORKSTATION", "goal-executor", "execute-goal", "~/.you-agent-factory/factories", "@you%2Fgoal", "INVOCATION_INPUT_SOURCE_CONFLICT", "editable", "`you docs authoring-factories`", "`you docs config`", "`you docs sessions`", "`you docs workstations`", "`you docs workers`"}, absent: []string{"[Authoring Factories](authoring-factories.md)", "[Config](config.md)", "[Sessions](sessions.md)"}},
