...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "serve-acp", heading: "# Host You As An ACP Agent", markers: []string{"you serve acp", `"args": ["serve", "acp"]`, "root.BuildProcess", "## Shutdown Behavior", "Clean stdin EOF", "cancellation outcome", "## Configure A Minimal ACP Client", "acpx@0.13.0", "## Exchange One ACP Prompt", "session/new", "session/prompt", "assistant result update", "end_turn", "## Distinguish This From Related ACP And MCP Surfaces", "you workers acp add", "you workers acp delete", "you mcp serve", "you acp serve", "not a recognized command", "## Know What Is Proven", "root_serve_test.go", "serve_acp_prompt_test.go", "pinned_acpx_test.go", "`you docs providers`", "`you docs mcp`", "`you docs sessions`"}, absent: []string{"you docs serve-acp-hosts", "Neither command is an alias for `you workers acp`"}},
}
