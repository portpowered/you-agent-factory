...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "batch-inputs", heading: "# Batch Inputs", markers: []string{"FACTORY_REQUEST_BATCH", "DEPENDS_ON", "PARENT_CHILD", "factory/inputs/BATCH/default/<request_id>.json", "requestId", "workTypeName", "sourceWorkName", "targetWorkName", "requiredState", "you docs relationships", "[Relationships](relationships.md)", "[Guards](guards.md)"}, absent: []string{"../internal/development/parent-aware-fan-in.md", "work_type_name", "source_work_name"}},
	{name: "batch-work", heading: "# Batch Inputs", markers: []string{"FACTORY_REQUEST_BATCH", "DEPENDS_ON", "PARENT_CHILD", "factory/inputs/BATCH/default/<request_id>.json", "requestId", "workTypeName", "sourceWorkName", "targetWorkName"}, absent: []string{"# Batch Work", "docs/reference/batch-work.md", "work_type_name", "source_work_name"}},
