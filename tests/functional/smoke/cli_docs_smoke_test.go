...
var docsSmokeTopics = []docsSmokeTopic{
	...
	{name: "authoring-factories", heading: "# Authoring Factories", markers: []string{"factory.json", "workers/<name>/AGENTS.md", "workstations/<name>/AGENTS.md", "you run --factory ./factory.json \"Fix the lint issues\"", "handlingBehavior: [\"DEFAULT\"]", "you run --dir ./factory --with-mock-workers", "you docs mock-workers", "you docs record-replay", "you docs packaged-goal", "you docs packaged-tts", "`you docs agents`", "--no-record", "requestId", "workTypeName"}, absent: []string{"work_type_name", "source_work_name", `"request_id"`, "[Agents](agents.md)"}},
	{name: "packaged-goal", heading: "# Packaged Goal (`@you/goal`)", markers: []string{"you run --named @you/goal", "browser or dashboard interaction", "primaryResult", "SUBMITTED_WORK_TERMINAL", "avoids binding a localhost API listener", "~/.you-agent-factory/factories", "@you%2Fgoal", "INVOCATION_INPUT_SOURCE_CONFLICT", "editable", "invocation-return contract", "`you docs authoring-factories`", "`you docs config`", "`you docs sessions`"}, absent: []string{"[Authoring Factories](authoring-factories.md)", "[Config](config.md)", "[Sessions](sessions.md)"}},
