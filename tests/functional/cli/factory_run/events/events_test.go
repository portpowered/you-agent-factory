...
func TestSuccessfulInvocationEmitsCanonicalNDJSON(t *testing.T) {
	...
	for index, record := range records {
		...
		case factoryEventRecordType:
			...
			assertFactoryEventRecord(t, record, index, &previousSequence, &previousSessionSequence)
			factoryEventCount++
