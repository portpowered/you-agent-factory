...
func TestFactoryRuntimeEnginePipelineMoveDestinationsLocked(t *testing.T) {
	...
	cases := []struct {
		...
		{path: "pkg/services/factory_runtime/engine", wantSuccessor: orchestrationSuccessor, wantDestination: "factory_runtime"},
		...
		{path: "pkg/services/factory_runtime/runtime", wantSuccessor: orchestrationSuccessor, wantDestination: "factory_runtime"},
		{path: "pkg/services/factory_runtime/runtime/buffers", wantSuccessor: orchestrationSuccessor, wantDestination: "factory_runtime"},
		{path: "pkg/services/factory_runtime/runtimecontract", wantSuccessor: orchestrationSuccessor, wantDestination: "factory_runtime"},
		{path: "pkg/services/factory_runtime/scheduler", wantSuccessor: orchestrationSuccessor, wantDestination: "factory_runtime"},
		{path: "pkg/services/factory_runtime/state", wantSuccessor: orchestrationSuccessor, wantDestination: "factory_runtime"},
		{path: "pkg/services/factory_runtime/state/validation", wantSuccessor: orchestrationSuccessor, wantDestination: "factory_runtime"},
		{path: "pkg/services/factory_runtime/subsystems", wantSuccessor: orchestrationSuccessor, wantDestination: "factory_runtime"},
