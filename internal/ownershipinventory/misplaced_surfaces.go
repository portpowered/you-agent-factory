...
func committedOwnedRoles() []OwnedRoleEntry {
	return []OwnedRoleEntry{
		...
		{ID: "lifecycle_role:automations-hosted-sources", Kind: OwnedRoleKindLifecycleRole, Name: "Automation Hosted Sources lifecycle", Destination: "automations", Note: "Hosted polling/source reconciliation lifecycle is owned by Automations."},
		...
		{ID: "lifecycle_role:providers-execution", Kind: OwnedRoleKindLifecycleRole, Name: "Providers Execution attempt lifecycle", Destination: "providers", Note: "Normalized provider inference attempt lifecycle is owned by Providers Execution."},
