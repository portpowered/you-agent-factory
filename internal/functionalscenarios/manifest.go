...
func applyReviewedEvidence(scenario *Scenario) {
	...
	case "cli/you.run":
		markCovered(scenario, LaneLong, "tests/functional/smoke/cli_factory_prompt_run_smoke_test.go::TestFactoryPromptRun_RealCLIWritesPrimaryResultFromPositionalText", InterfaceCLI)
