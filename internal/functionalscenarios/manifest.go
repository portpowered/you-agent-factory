...
func applyReviewedEvidence(scenario *Scenario) {
	...
	case "cli/you.session.resource.set":
		markCovered(scenario, LaneShort, "tests/functional/workers/mock/shared_process_test.go::TestSharedProcessWorkersMock", InterfaceCLI)
	...
	case "cli/you.worker-sessions.history":
		markCovered(scenario, LaneShort, "tests/functional/workers/recorded_history/history_test.go::TestWorkerSessionsHistoryCLIReportsTrustedRecordedAssociations", InterfaceCLI)
