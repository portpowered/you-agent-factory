...
const protectedFiles = [
	...
	"pkg/config/openapitests/testdata/baseline/factory-openapi-parity-index.json",
	"pkg/config/mockworkers/testdata/baseline/mock-workers-topology.json",
	"pkg/orchestrators/javascript/runtime/javascript-runtime-symbols.json",
