...
curl -fsSL "$INSTALL_SCRIPT_URL" | env \
  HOME="$TEMP_HOME" \
  INFINITE_YOU_VERSION="$INSTALL_VERSION" \
  INFINITE_YOU_INSTALL_DIR="$INSTALL_DIR" \
  INFINITE_YOU_INSTALL_BASE_URL="${INFINITE_YOU_INSTALL_BASE_URL:-}" \
  INFINITE_YOU_INSTALL_OS="${INFINITE_YOU_INSTALL_OS:-}" \
  INFINITE_YOU_INSTALL_ARCH="${INFINITE_YOU_INSTALL_ARCH:-}" \
  sh
