...
| `@you-agent-factory/api/components/*` | Raw shared JSON or YAML component artifacts |
...
runtime-contract, component, and joined artifacts. Parse `.json` files as JSON
and pass `.yaml` files to the YAML reader chosen by your application.
