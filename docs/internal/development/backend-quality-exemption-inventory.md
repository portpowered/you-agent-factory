...
| Batch 006 — `converge-work-family` | The remaining named source roots (`pkg/invocations`, `pkg/timework`, and `pkg/workgraph`) have no directive file in this snapshot. |
