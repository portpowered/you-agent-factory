...
Infinite-you loads Cursor provider-session detail from **cursor-agent CLI storage** parsed in-process by the parent-private Cursor Reader at `pkg/services/provider_sessions/internal/services/cursor_reader`. The external [`cursor-session`](https://github.com/iksnae/cursor-session) CLI is not invoked at runtime.
...
MIT-ported parsing from `iksnae/cursor-session` at commit `340f0f72a760ba8b454eac814f986d1a6a4c2f57`. See `pkg/services/provider_sessions/internal/services/cursor_reader/internal/cursor/NOTICE.md`.
