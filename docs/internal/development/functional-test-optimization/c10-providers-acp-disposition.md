...
| `daemon_crash_recovery_test.go` | Pass crash/disconnect marker paths through fixture and add `t.Parallel`. | Fixture seam reimplemented; crash/replacement parallel marker discarded pending audit; lifecycle witness retained. |
