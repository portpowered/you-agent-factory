...
- Backend named-factory export and import seams owned by `GET /factory-sessions/{session_id}/factory`
  and `POST /factories`
...
| UI metadata roundtrip and export dialog states | `ui/src/features/export/factory-png-export.test.ts`, `ui/src/features/export/components/export-factory-dialog.test.tsx`, `ui/src/features/import/factory-png-import.test.ts`, `ui/src/features/import/use-factory-import-activation.test.tsx`, `ui/src/features/export/components/export-factory-dialog.stories.tsx`, `ui/scripts/verify-import-export-storybook-responsive.mjs` | None for this lane beyond optional reviewer reruns |
...
| Shared UI direction and local architecture intent | `ui/src/features/workflow-activity/mutation-dialog.test.tsx`, `ui/src/features/export/components/export-factory-dialog.test.tsx`, `ui/src/features/import/dashboard-import-preview-dialog.test.tsx` | None for this lane beyond optional reviewer reruns |
