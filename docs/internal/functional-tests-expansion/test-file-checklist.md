...
## Current repository scenario cells

- [x] `tests/functional/acceptance/harness_smoke_test.go`
- [x] `tests/functional/acceptance/provider_outcomes_test.go`
- [x] `tests/functional/chat_sessions/root_composition/acp_multi_turn_test.go`
- [x] `tests/functional/chat_sessions/root_composition/acp_packaged_factory_prompt_test.go`
- [x] `tests/functional/chat_sessions/root_composition/acp_prompt_delegation_test.go`
- [x] `tests/functional/chat_sessions/root_composition/acp_server_composition_test.go`
- [x] `tests/functional/chat_sessions/root_composition/acp_streaming_composition_test.go`
- [x] `tests/functional/chat_sessions/root_composition/acp_streaming_usage_composition_test.go`
- [x] `tests/functional/chat_sessions/root_composition/acp_worker_child_events_test.go`
- [x] `tests/functional/cli/input_contract/canonical_input_contract_test.go`
- [x] `tests/functional/cli/named_invocation/named_invocation_test.go`
- [x] `tests/functional/events/factory_events/webhooks_test.go`
- [x] `tests/functional/events/response_events/concurrent_session_isolation_test.go`
- [x] `tests/functional/events/response_events/delegation_test.go`
- [x] `tests/functional/events/response_events/session_runtime_replace_test.go`
- [x] `tests/functional/events/response_events/terminal_outcomes_test.go`
- [x] `tests/functional/factory_runtime/root_composition/dispatch_worker_sessions_concurrency_activation_test.go`
- [x] `tests/functional/factory/batch/batch_characterization_test.go`
- [x] `tests/functional/factory/definitions/execution_catalog_test.go`
- [x] `tests/functional/factory/definitions/factory_validation_docs_test.go`
- [x] `tests/functional/factory/invocation/btrc_p0_cancellation_characterization_test.go`
- [x] `tests/functional/factory/invocation/characterization_test.go`
- [x] `tests/functional/factory/packaged/catalog/acp_invocability_test.go`
- [x] `tests/functional/factory/packaged/classify/invocation_test.go`
- [x] `tests/functional/factory/packaged/factory_builder/greeting_test.go`
- [x] `tests/functional/factory/packaged/factory_builder/invocation_test.go`
- [x] `tests/functional/factory/packaged/full_flow/invocation_test.go`
- [x] `tests/functional/factory/packaged/goal/invocation_interpolation_test.go`
- [x] `tests/functional/factory/packaged/goal/persistence_test.go`
- [x] `tests/functional/factory/packaged/loop/invocation_test.go`
- [x] `tests/functional/factory/packaged/plan_execute/invocation_test.go`
- [x] `tests/functional/factory/packaged/plan_parallel/invocation_test.go`
- [x] `tests/functional/factory/packaged/review/decision_envelope_malformed_test.go`
- [x] `tests/functional/factory/packaged/review/decision_envelope_recorded_work_test.go`
- [x] `tests/functional/factory/pending_approval/human_approval_test.go`
- [x] `tests/functional/guards/batch/all_children_complete_test.go`
- [x] `tests/functional/models/model_invoke/cli_test.go`
- [x] `tests/functional/observability/verification/functional_runner_contract_test.go`
- [x] `tests/functional/observability/verification/script_environment_contract_test.go`
- [x] `tests/functional/operator_settings/root_composition/build_process_inert_test.go`
- [x] `tests/functional/operator_settings/root_composition/defaults_resolution_fallback_test.go`
- [x] `tests/functional/operator_settings/root_composition/identity_input_inventory_activation_test.go`
- [x] `tests/functional/operator_settings/root_composition/operator_config_activation_test.go`
- [x] `tests/functional/operator_settings/root_composition/packaged_root_shape_test.go`
- [x] `tests/functional/operator_settings/root_composition/transport_activation_test.go`
- [x] `tests/functional/operator_settings/root_composition/wire_composition_coverage_test.go`
- [x] `tests/functional/orchestration/petri/dispatch/executor_panic_test.go`
- [x] `tests/functional/orchestration/petri/guards/secondary_dependency_join_test.go`
- [x] `tests/functional/provider_sessions/cli/stream_abort_test.go`
- [x] `tests/functional/provider_sessions/cli/worker_sessions_cli_test.go`
- [x] `tests/functional/provider_sessions/rollout/large_rollout_test.go`
- [x] `tests/functional/providers/acp/acp_error_test.go`
- [x] `tests/functional/providers/acp/acp_provider_events_test.go`
- [x] `tests/functional/providers/acp/basic_factory_run_test.go`
- [x] `tests/functional/providers/acp/btrc_p0_characterization_test.go`
- [x] `tests/functional/providers/acp/catalog_cli_negative_test.go`
- [x] `tests/functional/providers/acp/catalog_cli_test.go`
- [x] `tests/functional/providers/acp/daemon_concurrency_test.go`
- [x] `tests/functional/providers/acp/daemon_crash_recovery_test.go`
- [x] `tests/functional/providers/acp/daemon_reuse_test.go`
- [x] `tests/functional/providers/acp/daemon_shutdown_test.go`
- [x] `tests/functional/providers/acp/golden_fixture_test.go`
- [x] `tests/functional/providers/acp/golden_rpc_peer_test.go`
- [x] `tests/functional/providers/acp/javascript_factory_run_test.go`
- [x] `tests/functional/providers/acp/mixed_provider_factory_test.go`
- [x] `tests/functional/providers/acp/packaged_conformance_test.go`
- [x] `tests/functional/providers/acp/packaged_spawn_test.go`
- [x] `tests/functional/providers/acp/packaged_tournament_test.go`
- [x] `tests/functional/providers/acp/run_failure_diagnostics_test.go`
- [x] `tests/functional/providers/acp/run_parameters_content_test.go`
- [x] `tests/functional/providers/acp/run_permissions_test.go`
- [x] `tests/functional/providers/acp/run_unsupported_capabilities_test.go`
- [x] `tests/functional/providers/agy/golden_test.go`
- [x] `tests/functional/providers/agy/live_smoke_test.go`
- [x] `tests/functional/providers/agy/production_review_test.go`
- [x] `tests/functional/providers/claude/haiku_golden_test.go`
- [x] `tests/functional/providers/claude/process_harness_test.go`
- [x] `tests/functional/providers/discovery/discovery_test.go`
- [x] `tests/functional/providers/permission/permission_bypass_test.go`
- [x] `tests/functional/recordings/root_composition/build_process_inert_test.go`
- [x] `tests/functional/recordings/root_composition/event_artifact_projection_activation_test.go`
- [x] `tests/functional/recordings/root_composition/portable_replay_execution_test.go`
- [x] `tests/functional/recordings/root_composition/portable_transport_activation_test.go`
- [x] `tests/functional/recordings/root_composition/record_replay_lifecycle_activation_test.go`
- [x] `tests/functional/sessions/execution/drain_test.go`
- [x] `tests/functional/sessions/lifecycle/remote_lifecycle_test.go`
- [x] `tests/functional/sessions/live_change_contract_test.go`
- [x] `tests/functional/sessions/root_composition/application_opening_failure_test.go`
- [x] `tests/functional/sessions/root_composition/detached_operations_contract_test.go`
- [x] `tests/functional/sessions/root_composition/detached_operations_root_test.go`
- [x] `tests/functional/sessions/root_composition/dispatch_planning_cancellation_test.go`
- [x] `tests/functional/sessions/root_composition/p3_p7_behavior_matrix_test.go`
...
- [x] `tests/functional/transport/acp/stdio/cli_serve_acp_controls_test.go`
- [x] `tests/functional/transport/acp/stdio/cli_serve_acp_prompt_test.go`
- [x] `tests/functional/transport/acp/stdio/cli_serve_acp_wire_log_test.go`
- [x] `tests/functional/transport/cli/commands/human_approval_wiring_test.go`
- [x] `tests/functional/transport/cli/process/acp_shutdown_test.go`
- [x] `tests/functional/transport/cli/process/hard_kill_successor_process_nonwindows_lifecycle_test.go`
- [x] `tests/functional/transport/cli/process/hard_kill_successor_test.go`
- [x] `tests/functional/transport/cli/process/watch_abort_test.go`
- [x] `tests/functional/transport/http/server/work_terminal_response_test.go`
- [x] `tests/functional/transport/run_scoped_server/run_scoped_server_test.go`
- [x] `tests/functional/transport/server_binding/server_binding_test.go`
- [x] `tests/functional/transport/shell_completion/shell_completion_test.go`
- [x] `tests/functional/work/transports/cli/list_filters_counts_test.go`
- [x] `tests/functional/work/watch/production_ledger_test.go`
- [x] `tests/functional/work/watch/watch_test.go`
- [x] `tests/functional/workers/agent/root_build_test.go`
- [x] `tests/functional/workers/agent/stateless_root_test.go`
- [x] `tests/functional/workers/concurrency/concurrent_sessions_workers_isolation_test.go`
- [x] `tests/functional/workers/inference/opening_record_test.go`
- [x] `tests/functional/workers/inference/portable_recording_test.go`
- [x] `tests/functional/workers/inference/recording_gate_test.go`
- [x] `tests/functional/workers/inference/recording_health_test.go`
- [x] `tests/functional/workers/inference/recording_recovery_test.go`
- [x] `tests/functional/workers/inference/structured_result_test.go`
- [x] `tests/functional/workers/inference/worker_session_id_cursor_follow_test.go`
- [x] `tests/functional/workers/inference/worker_session_id_history_test.go`
- [x] `tests/functional/workers/invoke_continue/manager_interrupt_scenario_test.go`
- [x] `tests/functional/workers/invoke_continue/manager_scenario_test.go`
- [x] `tests/functional/workers/invoke_continue/provider_continuation_root_test.go`
- [x] `tests/functional/workers/invoke_continue/worker_sessions_invoke_continue_test.go`
- [x] `tests/functional/workers/mock/artifact_registry_test.go`
- [x] `tests/functional/workers/mock/classifier_test.go`
- [x] `tests/functional/workers/mock/live_capacity_javascript_test.go`
- [x] `tests/functional/workers/mock/live_capacity_test.go`
- [x] `tests/functional/workers/mock/plain_batch_drain_test.go`
- [x] `tests/functional/workers/mock/root_build_test.go`
- [x] `tests/functional/workers/transports/http/worker_sessions_invoke_continue_test.go`
- [x] `tests/functional/workers/transports/http/worker_sessions_lifecycle_test.go`
- [x] `tests/functional/workflow/config_driven_retry_loop_breaker_test.go`
- [x] `tests/functional/workstations/agentrun/agent_run_harness_test.go`
- [x] `tests/functional/workstations/execution/prompt_hot_reload_test.go`
- [x] `tests/functional/workstations/execution/structured_result_prompt_test.go`
- [x] `tests/functional/workstations/poller/hosted_characterization_test.go`

## Published packaged-factory invocation cells

- [x] `tests/functional/factory/packaged/agy_clip_qa/invocation_test.go`
- [x] `tests/functional/factory/packaged/agy_cold_watch/invocation_test.go`
- [x] `tests/functional/factory/packaged/spawn/invocation_test.go`
- [x] `tests/functional/factory/packaged/tournament/invocation_test.go`
...
- [x] `tests/functional/factory/definitions/snapshots_portability_test.go`
- [x] `tests/functional/factory/packaged/catalog/publication_test.go`
- [x] `tests/functional/factory/packaged/fix/invocation_test.go`
- [x] `tests/functional/factory/packaged/ralph/invocation_test.go`
- [x] `tests/functional/factory/packaged/tts/local_runtime_invocation_test.go`
- [x] `tests/functional/factory/visualization/runtime_metrics/documented_workflow_test.go`
- [x] `tests/functional/factory/visualization/runtime_metrics/end_to_end_costs_test.go`
- [x] `tests/functional/factory/visualization/runtime_metrics/metrics_cli_test.go`
- [x] `tests/functional/factory/visualization/runtime_metrics/probe_cost_test.go`
- [x] `tests/functional/factory/visualization/runtime_metrics/probe_observability_test.go`
- [x] `tests/functional/factory/visualization/runtime_metrics/replay_priced_cost_test.go`
- [x] `tests/functional/factory/visualization/runtime_metrics/replay_unpriced_cost_test.go`
- [x] `tests/functional/factory/visualization/runtime_metrics/replay_usage_fixtures_test.go`
- [x] `tests/functional/internal/support/session_parity_contract_test.go`
- [x] `tests/functional/models/model_list/cli_test.go`
- [x] `tests/functional/models/root_composition/asr_story_test.go`
- [x] `tests/functional/models/root_composition/coded_diagnostics_test.go`
- [x] `tests/functional/models/root_composition/delivered_cli_story_test.go`
- [x] `tests/functional/models/root_composition/inference_failure_test.go`
- [x] `tests/functional/models/root_composition/pull_to_ready_test.go`
- [x] `tests/functional/models/root_composition/story_001_test.go`
- [x] `tests/functional/models/root_composition/story_002_test.go`
- [x] `tests/functional/models/root_composition/story_003_test.go`
- [x] `tests/functional/models/root_composition/tts_story_test.go`
- [x] `tests/functional/observability/runtime_startup/startup_ordering_test.go`
- [x] `tests/functional/observability/verification/fmt_check_test.go`
- [x] `tests/functional/operator_settings/configcore/operator_config_core_test.go`
- [x] `tests/functional/orchestration/javascript/workers/permissions_matrix_test.go`
- [x] `tests/functional/orchestration/petri/guards/logical_round_trip_test.go`
- [x] `tests/functional/provider_sessions/cli/worker_sessions_fleet_list_test.go`
- [x] `tests/functional/providers/codex/codex_untrusted_working_directory_test.go`
- [x] `tests/functional/recordings/process/recording_flush_before_shutdown_test.go`
- [x] `tests/functional/recordings/process/recording_flush_before_shutdown_windows_test.go`
- [x] `tests/functional/replay_contracts/replay_record_end_to_end_long_test.go`
- [x] `tests/functional/runtime_api/api_session_invocation_test.go`
- [x] `tests/functional/sessions/restart/board_persistence_cli_test.go`
- [x] `tests/functional/sessions/resume_from_recording/resume_from_recording_test.go`
- [x] `tests/functional/sessions/root_composition/secret_redaction_runtime_guard_test.go`
- [x] `tests/functional/sessions/root_composition/seeded_replay_resume_activation_test.go`
- [x] `tests/functional/transport/cli/process/graceful_shutdown_process_windows_test.go`
- [x] `tests/functional/work/relationships/cross_batch_isolation_test.go`
- [x] `tests/functional/work/relationships/cross_batch_terminal_test.go`
- [x] `tests/functional/work/relationships/shared_server_test.go`
- [x] `tests/functional/work/submission/payload_size_http_test.go`
- [x] `tests/functional/workers/mock/agy_named_mock_test.go`
- [x] `tests/functional/workers/mock/batch_invocation_exit_codes_test.go`
- [x] `tests/functional/workers/mock/named_invocation_exit_codes_test.go`
- [x] `tests/functional/workers/mock/usage_costs_test.go`
- [x] `tests/functional/workers/transports/http/worker_sessions_read_surface_test.go`
