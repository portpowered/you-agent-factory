...
`pkg/services/workers/internal/providercompat/inferencecontract`. It is deliberately separate
...
Use `pkg/services/workers/internal/providercompat/inferencecontract/testkit` with deterministic,
