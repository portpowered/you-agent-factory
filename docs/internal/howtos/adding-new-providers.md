...
`pkg/services/workers/providercompat/inferencecontract`. It is deliberately separate
...
Use `pkg/services/workers/providercompat/inferencecontract/testkit` with deterministic,
