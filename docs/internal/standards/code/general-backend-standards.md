...
- The durable product-owned root package families are: `pkg/config`, `pkg/factory`, `pkg/initializer`, `pkg/interfaces`, `pkg/internal`, `pkg/models`, `pkg/orchestrators`, `pkg/root`, `pkg/testutil`, `pkg/transports`, `pkg/platform`, `pkg/wire`, `pkg/work`, and `pkg/workers`.
