...
- The durable product-owned root package families are: `pkg/config`, `pkg/factory`, `pkg/hostedworkers`, `pkg/initializer`, `pkg/interfaces`, `pkg/internal`, `pkg/localmodels`, `pkg/modelhost`, `pkg/models`, `pkg/orchestrators`, `pkg/root`, `pkg/testutil`, `pkg/transports`, `pkg/platform`, `pkg/wire`, `pkg/work`, and `pkg/workers`.
...
- The converged factory and orchestrator roots `pkg/packagedfactories`, `pkg/factorydefinition`, `pkg/factorysessionexecution`, `pkg/factorysessions`, and `pkg/petri` have been retired. Production code **MUST** import their canonical owners under `pkg/factory/packages`, `pkg/factory/definition`, `pkg/factory/sessions/execution`, `pkg/factory/sessions`, and `pkg/orchestrators/petri`, respectively. The package-boundary guard rejects both recreated retired roots and imports of those paths with the matching canonical-owner remediation.
- The package-boundary guard blocks imports of `pkg/wire` from domain and transport packages. `pkg/wire` may import inward owners, and only `pkg/root`, `pkg/initializer`, and `pkg/wire` itself may import the typed application graph.
