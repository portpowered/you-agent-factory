...
var (
	//go:embed agents.md authoring-factories.md batch-inputs.md config.md guards.md javascript-workflows.md mcp.md mock-workers.md models.md orchestrators.md record-replay.md relationships.md resources.md run.md sessions.md templates.md work.md workers.md workstations.md
