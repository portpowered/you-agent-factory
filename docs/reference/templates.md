...
`you docs templates` prints this guide from the packaged CLI topic list. The
repository file is `docs/reference/templates.md`. Cross-cutting guard and
relationship behavior is documented in `you docs guards`
and `you docs relationships`.
