...
| --- | --- | --- |
| Backend contract and persistence | `tests/functional/bootstrap_portability/api_export_import_e2e_smoke_test.go`, `tests/functional/runtime_api/api_named_factory_test.go`, `pkg/api/openapi_contract_test.go`, `pkg/service/factory_test.go` | Final `US-004` regression bundle write-up only |
| UI metadata roundtrip | `ui/src/features/export/factory-png-export.test.ts`, `ui/src/features/export/export-factory-dialog.test.tsx`, `ui/src/features/import/factory-png-import.test.ts`, `ui/src/features/import/use-factory-import-activation.test.tsx`, `ui/src/features/export/export-factory-dialog.stories.tsx` | Final `US-004` verification bundle write-up only |
| UI drag/drop lifecycle | `ui/src/features/import/use-factory-png-drop.test.tsx`, `ui/src/features/workflow-activity/dashboard-import-preview-dialog.stories.tsx` | Final `US-004` verification bundle write-up only |
