...
| UI metadata roundtrip | `ui/src/features/export/factory-png-export.test.ts`, `ui/src/features/export/export-factory-dialog.test.tsx`, `ui/src/features/import/factory-png-import.test.ts`, `ui/src/features/import/use-factory-import-activation.test.tsx` | Browser confirmation after frontend gap closure |
...
- `US-003`: close the remaining frontend gaps around keyboard and focus
  confirmation plus responsive verification in browser.
