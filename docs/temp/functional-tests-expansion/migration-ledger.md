...
_Status: partial — runtime_api bindings filled by FND-007-003; remaining catch-all bindings filled by later stories._
...
| `docs-reference-smoke` | TBD (smoke package; FND-007-004) | TBD | Not a runtime_api binding |
...
_Status: partial — runtime_api batches filled by FND-007-003; featureless catch-all batches added by FND-007-004…005._
